...
_A TrafficSpace is a space in which traffic takes place. Traffic includes the movement of entities such as trains, vehicles, pedestrians, ships, or other transportation types._
...
```mermaid
 classDiagram
    ...
    click TrafficSpace href "../TrafficSpace/"
      AbstractUnoccupiedSpace <|-- TrafficSpace
        click AbstractUnoccupiedSpace href "../AbstractUnoccupiedSpace/"
      
      TrafficSpace : adeOfAbstractCityObject
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      TrafficSpace : adeOfAbstractFeature
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      TrafficSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      TrafficSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      TrafficSpace : adeOfAbstractSpace
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      TrafficSpace : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        TrafficSpace --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        click ADEOfAbstractUnoccupiedSpace href "../ADEOfAbstractUnoccupiedSpace/"
    

        
      TrafficSpace : adeOfTrafficSpace
        
          
    
        
        
        TrafficSpace --> "*" ADEOfTrafficSpace : adeOfTrafficSpace
        click ADEOfTrafficSpace href "../ADEOfTrafficSpace/"
    

        
      TrafficSpace : appearance
        
          
    
        
        
        TrafficSpace --> "*" AbstractAppearance : appearance
      ...
      TrafficSpace : area
        ...
        TrafficSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      TrafficSpace : boundary
        
          
    
        
        
        TrafficSpace --> "*" TrafficArea : boundary
      ...
      TrafficSpace : class
        ...
        TrafficSpace --> "0..1" TrafficSpaceClassValue : class
        click TrafficSpaceClassValue href "../TrafficSpaceClassValue/"
    

        
      TrafficSpace : clearanceSpace
        
          
    
        
        
        TrafficSpace --> "*" ClearanceSpace : clearanceSpace
        click ClearanceSpace href "../ClearanceSpace/"
    

        
      TrafficSpace : creationDate
        
      TrafficSpace : description
        
      TrafficSpace : dynamizer
        
          
    
        
        
        TrafficSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      TrafficSpace : externalReference
        
          
    
        
        
        TrafficSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      TrafficSpace : featureID
        
          
    
        
        
        TrafficSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      TrafficSpace : function
        
          
    
        
        
        TrafficSpace --> "*" TrafficSpaceFunctionValue : function
        click TrafficSpaceFunctionValue href "../TrafficSpaceFunctionValue/"
    

        
      TrafficSpace : generalizesTo
        
          
    
        
        
        TrafficSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      TrafficSpace : genericAttribute
        
          
    
        
        
        TrafficSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      TrafficSpace : granularity
        
          
    
        
        
        TrafficSpace --> "1" GranularityValue : granularity
        click GranularityValue href "../GranularityValue/"
    

        
      TrafficSpace : identifier
        
      TrafficSpace : lod0MultiCurve
        
      TrafficSpace : lod0MultiSurface
        
      TrafficSpace : lod0Point
        
      TrafficSpace : lod1Solid
        
      TrafficSpace : lod1TerrainIntersectionCurve
        
      TrafficSpace : lod2MultiCurve
        
      TrafficSpace : lod2MultiSurface
        
      TrafficSpace : lod2Solid
        
      TrafficSpace : lod2TerrainIntersectionCurve
        
      TrafficSpace : lod3MultiCurve
        
      TrafficSpace : lod3MultiSurface
        
      TrafficSpace : lod3Solid
        
      TrafficSpace : lod3TerrainIntersectionCurve
        
      TrafficSpace : name
        
      TrafficSpace : occupancy
        
          
    
        
        
        TrafficSpace --> "*" Occupancy : occupancy
        click Occupancy href "../Occupancy/"
    

        
      TrafficSpace : pointCloud
        
          
    
        
        
        TrafficSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      TrafficSpace : predecessor
        
          
    
        
        
        TrafficSpace --> "*" TrafficSpace : predecessor
        click TrafficSpace href "../TrafficSpace/"
    

        
      TrafficSpace : relatedTo
        
          
    
        
        
        TrafficSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      TrafficSpace : relativeToTerrain
        
          
    
        
        
        TrafficSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      TrafficSpace : relativeToWater
        
          
    
        
        
        TrafficSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      TrafficSpace : spaceType
        
          
    
        
        
        TrafficSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      TrafficSpace : successor
        
          
    
        
        
        TrafficSpace --> "*" TrafficSpace : successor
        click TrafficSpace href "../TrafficSpace/"
    

        
      TrafficSpace : terminationDate
        
      TrafficSpace : trafficDirection
        
          
    
        
        
        TrafficSpace --> "0..1" TrafficDirectionValue : trafficDirection
      ...
      TrafficSpace : usage
        ...
        TrafficSpace --> "*" TrafficSpaceUsageValue : usage
        click TrafficSpaceUsageValue href "../TrafficSpaceUsageValue/"
    

        
      TrafficSpace : validFrom
        
      TrafficSpace : validTo
      ...
      TrafficSpace : volume
        ...
        TrafficSpace --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [TrafficSpaceClassValue](TrafficSpaceClassValue.md) | Indicates the specific type of the TrafficSpace | direct |
| [function](function.md) | * <br/> [TrafficSpaceFunctionValue](TrafficSpaceFunctionValue.md) | Specifies the intended purposes of the TrafficSpace | direct |
| [usage](usage.md) | * <br/> [TrafficSpaceUsageValue](TrafficSpaceUsageValue.md) | Specifies the actual uses of the TrafficSpace | direct |
| [granularity](granularity.md) | 1 <br/> [GranularityValue](GranularityValue.md) | Defines whether traffic spaces are represented by individual ways or by indiv... | direct |
...
| [adeOfTrafficSpace](adeOfTrafficSpace.md) | * <br/> [ADEOfTrafficSpace](ADEOfTrafficSpace.md) | Augments the TrafficSpace with properties defined in an ADE | direct |
| [predecessor](predecessor.md) | * <br/> [TrafficSpace](TrafficSpace.md) | Indicates the predecessor(s) of the TrafficSpace | direct |
| [clearanceSpace](clearanceSpace.md) | * <br/> [ClearanceSpace](ClearanceSpace.md) | Relates to the clearance spaces that are part of the TrafficSpace | direct |
| [boundary](boundary.md) | * <br/> [TrafficArea](TrafficArea.md) |  | direct |
| [successor](successor.md) | * <br/> [TrafficSpace](TrafficSpace.md) | Indicates the successor(s) of the TrafficSpace | direct |
...
| ---  | --- | --- | --- |
| [AbstractTransportationSpace](AbstractTransportationSpace.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Intersection](Intersection.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Railway](Railway.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Road](Road.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Section](Section.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Square](Square.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Track](Track.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
| [TrafficSpace](TrafficSpace.md) | [predecessor](predecessor.md) | range | [TrafficSpace](TrafficSpace.md) |
| [TrafficSpace](TrafficSpace.md) | [successor](successor.md) | range | [TrafficSpace](TrafficSpace.md) |
| [Waterway](Waterway.md) | [trafficSpace](trafficSpace.md) | range | [TrafficSpace](TrafficSpace.md) |
...
```yaml
name: TrafficSpace
description: A TrafficSpace is a space in which traffic takes place. Traffic includes
  the movement of entities such as trains, vehicles, pedestrians, ships, or other
...
attributes:
  ...
  function:
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: TrafficSpaceFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: TrafficSpaceUsageValue
    required: false
    multivalued: true
  granularity:
    name: granularity
    description: Defines whether traffic spaces are represented by individual ways
      or by individual lanes, depending on the desired level of spatial and semantic
      decomposition.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - AuxiliaryTrafficSpace
  ...
  occupancy:
    ...
    description: Provides information on the residency of persons, vehicles, or other
      moving features in the TrafficSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:

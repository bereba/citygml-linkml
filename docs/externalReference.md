...
_References external objects in other information systems that have a relation to the city object._
...
| Property | Value |
| --- | --- |
| Range | [ExternalReference](ExternalReference.md) |
...
description: References external objects in other information systems that have a
  relation to the city object.

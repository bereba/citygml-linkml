...
_A LandUse object is an area of the earth's surface dedicated to a specific land use or having a specific land cover with or without vegetation, such as sand, rock, mud flats, forest, grasslands, or wetlands._





URI: [citygml:LandUse](https://www.ogc.org/standards/citygml/LandUse)
...
```mermaid
 classDiagram
    ...
    click LandUse href "../LandUse/"
      ...
      LandUse : adeOfAbstractCityObject
        
          
    
        
        
        LandUse --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      LandUse : adeOfAbstractFeature
        
          
    
        
        
        LandUse --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      LandUse : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        LandUse --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      LandUse : adeOfAbstractSpaceBoundary
        
          
    
        
        
        LandUse --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      LandUse : adeOfAbstractThematicSurface
        
          
    
        
        
        LandUse --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      LandUse : adeOfLandUse
        
          
    
        
        
        LandUse --> "*" ADEOfLandUse : adeOfLandUse
        click ADEOfLandUse href "../ADEOfLandUse/"
      ...
      LandUse : appearance
        ...
        LandUse --> "*" AbstractAppearance : appearance
      ...
      LandUse : class
        ...
        LandUse --> "0..1" LandUseClassValue : class
        click LandUseClassValue href "../LandUseClassValue/"
    

        
      LandUse : creationDate
      ...
      LandUse : dynamizer
        ...
        LandUse --> "*" AbstractDynamizer : dynamizer
      ...
      LandUse : externalReference
        ...
        LandUse --> "*" ExternalReference : externalReference
      ...
      LandUse : function
        ...
        LandUse --> "*" LandUseFunctionValue : function
        click LandUseFunctionValue href "../LandUseFunctionValue/"
    

        
      LandUse : generalizesTo
        
          
    
        
        
        LandUse --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      LandUse : genericAttribute
        
          
    
        
        
        LandUse --> "*" AbstractGenericAttribute : genericAttribute
      ...
      LandUse : lod0MultiCurve
        
      LandUse : lod0MultiSurface
        
      LandUse : lod1MultiSurface
        
      LandUse : lod2MultiSurface
        
      LandUse : lod3MultiSurface
      ...
      LandUse : pointCloud
        ...
        LandUse --> "0..1" AbstractPointCloud : pointCloud
      ...
      LandUse : relatedTo
        ...
        LandUse --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      LandUse : relativeToTerrain
        
          
    
        
        
        LandUse --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      LandUse : relativeToWater
        
          
    
        
        
        LandUse --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      LandUse : terminationDate
      ...
      LandUse : usage
        ...
        LandUse --> "*" LandUseUsageValue : usage
        click LandUseUsageValue href "../LandUseUsageValue/"
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [LandUseClassValue](LandUseClassValue.md) | Indicates the specific type of the LandUse | direct |
| [function](function.md) | * <br/> [LandUseFunctionValue](LandUseFunctionValue.md) | Specifies the intended purposes of the LandUse | direct |
| [usage](usage.md) | * <br/> [LandUseUsageValue](LandUseUsageValue.md) | Specifies the actual uses of the LandUse | direct |
| [adeOfLandUse](adeOfLandUse.md) | * <br/> [ADEOfLandUse](ADEOfLandUse.md) | Augments the LandUse with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:LandUse |
| native | citygml:LandUse |
...
```yaml
name: LandUse
description: A LandUse object is an area of the earth's surface dedicated to a specific
  land use or having a specific land cover with or without vegetation, such as sand,
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the LandUse.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: LandUseClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the LandUse.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: LandUseFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the LandUse.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction

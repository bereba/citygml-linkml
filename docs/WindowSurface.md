...
_A WindowSurface is either a boundary surface of a Window feature or a surface that seals an opening filled by a window._





URI: [citygml:WindowSurface](https://www.ogc.org/standards/citygml/WindowSurface)
...
```mermaid
 classDiagram
    ...
    click WindowSurface href "../WindowSurface/"
      ...
      WindowSurface : adeOfAbstractCityObject
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      WindowSurface : adeOfAbstractFeature
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      WindowSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      WindowSurface : adeOfAbstractFillingSurface
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractFillingSurface : adeOfAbstractFillingSurface
        click ADEOfAbstractFillingSurface href "../ADEOfAbstractFillingSurface/"
    

        
      WindowSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      WindowSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        WindowSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      WindowSurface : adeOfWindowSurface
        
          
    
        
        
        WindowSurface --> "*" ADEOfWindowSurface : adeOfWindowSurface
        click ADEOfWindowSurface href "../ADEOfWindowSurface/"
    

        
      WindowSurface : appearance
        
          
    
        
        
        WindowSurface --> "*" AbstractAppearance : appearance
      ...
      WindowSurface : area
        ...
        WindowSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      WindowSurface : creationDate
        
      WindowSurface : description
        
      WindowSurface : dynamizer
        
          
    
        
        
        WindowSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      WindowSurface : externalReference
        
          
    
        
        
        WindowSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      WindowSurface : featureID
        
          
    
        
        
        WindowSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      WindowSurface : generalizesTo
        
          
    
        
        
        WindowSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WindowSurface : genericAttribute
        
          
    
        
        
        WindowSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      WindowSurface : identifier
        
      WindowSurface : lod0MultiCurve
        
      WindowSurface : lod0MultiSurface
        
      WindowSurface : lod1MultiSurface
        
      WindowSurface : lod2MultiSurface
        
      WindowSurface : lod3MultiSurface
        
      WindowSurface : name
        
      WindowSurface : pointCloud
        
          
    
        
        
        WindowSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      WindowSurface : relatedTo
        
          
    
        
        
        WindowSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WindowSurface : relativeToTerrain
        
          
    
        
        
        WindowSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      WindowSurface : relativeToWater
        
          
    
        
        
        WindowSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      WindowSurface : terminationDate
        
      WindowSurface : validFrom
        
      WindowSurface : validTo
...
| ---  | --- | --- | --- |
| [adeOfWindowSurface](adeOfWindowSurface.md) | * <br/> [ADEOfWindowSurface](ADEOfWindowSurface.md) | Augments the WindowSurface with properties defined in an ADE | direct |
...
| ---  | --- | --- | --- |
| [Window](Window.md) | [boundary](boundary.md) | range | [WindowSurface](WindowSurface.md) |
...
| ---  | ---  |
| self | citygml:WindowSurface |
| native | citygml:WindowSurface |
...
```yaml
name: WindowSurface
description: A WindowSurface is either a boundary surface of a Window feature or a
  surface that seals an opening filled by a window.

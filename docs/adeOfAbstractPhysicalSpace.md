...
# Slot: adeOfAbstractPhysicalSpace 


_Augments AbstractPhysicalSpace with properties defined in an ADE._
...
| Property | Value |
| --- | --- |
| Range | [ADEOfAbstractPhysicalSpace](ADEOfAbstractPhysicalSpace.md) |

...
_A WaterBody represents significant and permanent or semi-permanent accumulations of surface water, usually covering a part of the Earth._





URI: [citygml:WaterBody](https://www.ogc.org/standards/citygml/WaterBody)
...
```mermaid
 classDiagram
    ...
    click WaterBody href "../WaterBody/"
      ...
      WaterBody : adeOfAbstractCityObject
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      WaterBody : adeOfAbstractFeature
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      WaterBody : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      WaterBody : adeOfAbstractOccupiedSpace
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      WaterBody : adeOfAbstractPhysicalSpace
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      WaterBody : adeOfAbstractSpace
        
          
    
        
        
        WaterBody --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      WaterBody : adeOfWaterBody
        
          
    
        
        
        WaterBody --> "*" ADEOfWaterBody : adeOfWaterBody
        click ADEOfWaterBody href "../ADEOfWaterBody/"
    

        
      WaterBody : appearance
        
          
    
        
        
        WaterBody --> "*" AbstractAppearance : appearance
      ...
      WaterBody : boundary
        ...
        WaterBody --> "*" AbstractWaterBoundarySurface : boundary
      ...
      WaterBody : class
        ...
        WaterBody --> "0..1" WaterBodyClassValue : class
        click WaterBodyClassValue href "../WaterBodyClassValue/"
    

        
      WaterBody : creationDate
      ...
      WaterBody : dynamizer
        ...
        WaterBody --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      WaterBody : externalReference
        
          
    
        
        
        WaterBody --> "*" ExternalReference : externalReference
      ...
      WaterBody : function
        ...
        WaterBody --> "*" WaterBodyFunctionValue : function
        click WaterBodyFunctionValue href "../WaterBodyFunctionValue/"
    

        
      WaterBody : generalizesTo
        
          
    
        
        
        WaterBody --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WaterBody : genericAttribute
        
          
    
        
        
        WaterBody --> "*" AbstractGenericAttribute : genericAttribute
      ...
      WaterBody : lod0MultiCurve
        
      WaterBody : lod0MultiSurface
        
      WaterBody : lod0Point
        
      WaterBody : lod1ImplicitRepresentation
        
          
    
        
        
        WaterBody --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
      ...
      WaterBody : lod1TerrainIntersectionCurve
        
      WaterBody : lod2ImplicitRepresentation
        
          
    
        
        
        WaterBody --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      WaterBody : lod2MultiCurve
        
      WaterBody : lod2MultiSurface
        
      WaterBody : lod2Solid
        
      WaterBody : lod2TerrainIntersectionCurve
        
      WaterBody : lod3ImplicitRepresentation
        
          
    
        
        
        WaterBody --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      WaterBody : lod3MultiCurve
        
      WaterBody : lod3MultiSurface
        
      WaterBody : lod3Solid
        
      WaterBody : lod3TerrainIntersectionCurve
        
      WaterBody : name
        
      WaterBody : pointCloud
        
          
    
        
        
        WaterBody --> "0..1" AbstractPointCloud : pointCloud
      ...
      WaterBody : relatedTo
        ...
        WaterBody --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WaterBody : relativeToTerrain
        
          
    
        
        
        WaterBody --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      WaterBody : relativeToWater
        
          
    
        
        
        WaterBody --> "0..1" RelativeToWater : relativeToWater
      ...
      WaterBody : spaceType
        ...
        WaterBody --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      WaterBody : terminationDate
      ...
      WaterBody : usage
        ...
        WaterBody --> "*" WaterBodyUsageValue : usage
        click WaterBodyUsageValue href "../WaterBodyUsageValue/"
      ...
      WaterBody : volume
        ...
        WaterBody --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [WaterBodyClassValue](WaterBodyClassValue.md) | Indicates the specific type of the WaterBody | direct |
| [function](function.md) | * <br/> [WaterBodyFunctionValue](WaterBodyFunctionValue.md) | Specifies the intended purposes of the WaterBody | direct |
| [usage](usage.md) | * <br/> [WaterBodyUsageValue](WaterBodyUsageValue.md) | Specifies the actual uses of the WaterBody | direct |
| [adeOfWaterBody](adeOfWaterBody.md) | * <br/> [ADEOfWaterBody](ADEOfWaterBody.md) | Augments the WaterBody with properties defined in an ADE | direct |
| [boundary](boundary.md) | * <br/> [AbstractWaterBoundarySurface](AbstractWaterBoundarySurface.md) |  | direct |
...
| ---  | ---  |
| self | citygml:WaterBody |
| native | citygml:WaterBody |
...
```yaml
name: WaterBody
description: A WaterBody represents significant and permanent or semi-permanent accumulations
  of surface water, usually covering a part of the Earth.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the WaterBody.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: WaterBodyClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the WaterBody.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: WaterBodyFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the WaterBody.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
  ...
  boundary:
    ...
    - HollowSpace
    - WaterBody
    range: AbstractWaterBoundarySurface
    required: false
    multivalued: true

...
_A WallSurface is a surface that is part of the building facade visible from the outside._





URI: [citygml:WallSurface](https://www.ogc.org/standards/citygml/WallSurface)
...
```mermaid
 classDiagram
    ...
    click WallSurface href "../WallSurface/"
      ...
      WallSurface : adeOfAbstractCityObject
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      WallSurface : adeOfAbstractConstructionSurface
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractConstructionSurface : adeOfAbstractConstructionSurface
        click ADEOfAbstractConstructionSurface href "../ADEOfAbstractConstructionSurface/"
    

        
      WallSurface : adeOfAbstractFeature
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      WallSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      WallSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      WallSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        WallSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      WallSurface : adeOfWallSurface
        
          
    
        
        
        WallSurface --> "*" ADEOfWallSurface : adeOfWallSurface
        click ADEOfWallSurface href "../ADEOfWallSurface/"
    

        
      WallSurface : appearance
        
          
    
        
        
        WallSurface --> "*" AbstractAppearance : appearance
      ...
      WallSurface : area
        ...
        WallSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      WallSurface : creationDate
        
      WallSurface : description
        
      WallSurface : dynamizer
        
          
    
        
        
        WallSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      WallSurface : externalReference
        
          
    
        
        
        WallSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      WallSurface : featureID
        
          
    
        
        
        WallSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      WallSurface : fillingSurface
        
          
    
        
        
        WallSurface --> "*" AbstractFillingSurface : fillingSurface
        click AbstractFillingSurface href "../AbstractFillingSurface/"
    

        
      WallSurface : generalizesTo
        
          
    
        
        
        WallSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WallSurface : genericAttribute
        
          
    
        
        
        WallSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      WallSurface : identifier
        
      WallSurface : lod0MultiCurve
        
      WallSurface : lod0MultiSurface
        
      WallSurface : lod1MultiSurface
        
      WallSurface : lod2MultiSurface
        
      WallSurface : lod3MultiSurface
        
      WallSurface : name
        
      WallSurface : pointCloud
        
          
    
        
        
        WallSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      WallSurface : relatedTo
        
          
    
        
        
        WallSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WallSurface : relativeToTerrain
        
          
    
        
        
        WallSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      WallSurface : relativeToWater
        
          
    
        
        
        WallSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      WallSurface : terminationDate
        
      WallSurface : validFrom
...
| ---  | --- | --- | --- |
| [adeOfWallSurface](adeOfWallSurface.md) | * <br/> [ADEOfWallSurface](ADEOfWallSurface.md) | Augments the WallSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:WallSurface |
| native | citygml:WallSurface |
...
```yaml
name: WallSurface
description: A WallSurface is a surface that is part of the building facade visible
  from the outside.

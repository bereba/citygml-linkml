...
_AbstractLogicalSpace is the abstract superclass for all types of logical spaces. Logical space refers to spaces that are not bounded by physical surfaces but are defined according to thematic considerations._
...
URI: [citygml:AbstractLogicalSpace](https://www.ogc.org/standards/citygml/AbstractLogicalSpace)
...
```mermaid
 classDiagram
    ...
    click AbstractLogicalSpace href "../AbstractLogicalSpace/"
      AbstractSpace <|-- AbstractLogicalSpace
      ...
      AbstractLogicalSpace : adeOfAbstractCityObject
        
          
    
        
        
        AbstractLogicalSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractLogicalSpace : adeOfAbstractFeature
        
          
    
        
        
        AbstractLogicalSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractLogicalSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractLogicalSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractLogicalSpace : adeOfAbstractLogicalSpace
        
          
    
        
        
        AbstractLogicalSpace --> "*" ADEOfAbstractLogicalSpace : adeOfAbstractLogicalSpace
        click ADEOfAbstractLogicalSpace href "../ADEOfAbstractLogicalSpace/"
    

        
      AbstractLogicalSpace : adeOfAbstractSpace
        
          
    
        
        
        AbstractLogicalSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractLogicalSpace : appearance
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractLogicalSpace : area
        
          
    
        
        
        AbstractLogicalSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractLogicalSpace : boundary
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      AbstractLogicalSpace : creationDate
        
      AbstractLogicalSpace : description
        
      AbstractLogicalSpace : dynamizer
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractLogicalSpace : externalReference
        
          
    
        
        
        AbstractLogicalSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractLogicalSpace : featureID
        
          
    
        
        
        AbstractLogicalSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractLogicalSpace : generalizesTo
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractLogicalSpace : genericAttribute
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractLogicalSpace : identifier
        
      AbstractLogicalSpace : lod0MultiCurve
        
      AbstractLogicalSpace : lod0MultiSurface
        
      AbstractLogicalSpace : lod0Point
        
      AbstractLogicalSpace : lod1Solid
        
      AbstractLogicalSpace : lod2MultiCurve
        
      AbstractLogicalSpace : lod2MultiSurface
        
      AbstractLogicalSpace : lod2Solid
        
      AbstractLogicalSpace : lod3MultiCurve
        
      AbstractLogicalSpace : lod3MultiSurface
        
      AbstractLogicalSpace : lod3Solid
        
      AbstractLogicalSpace : name
        
      AbstractLogicalSpace : relatedTo
        
          
    
        
        
        AbstractLogicalSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractLogicalSpace : relativeToTerrain
        
          
    
        
        
        AbstractLogicalSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractLogicalSpace : relativeToWater
        
          
    
        
        
        AbstractLogicalSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractLogicalSpace : spaceType
        
          
    
        
        
        AbstractLogicalSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractLogicalSpace : terminationDate
        
      AbstractLogicalSpace : validFrom
        
      AbstractLogicalSpace : validTo
        
      AbstractLogicalSpace : volume
        
          
    
        
        
        AbstractLogicalSpace --> "*" QualifiedVolume : volume
        ...
        * [AbstractCityObject](AbstractCityObject.md)
            * [AbstractSpace](AbstractSpace.md)
                * **AbstractLogicalSpace**
                    ...
                    * [CityObjectGroup](CityObjectGroup.md)
                    * [GenericLogicalSpace](GenericLogicalSpace.md)
...
| ---  | --- | --- | --- |
| [adeOfAbstractLogicalSpace](adeOfAbstractLogicalSpace.md) | * <br/> [ADEOfAbstractLogicalSpace](ADEOfAbstractLogicalSpace.md) | Augments AbstractLogicalSpace with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:AbstractLogicalSpace |
| native | citygml:AbstractLogicalSpace |
...
<details>
```yaml
name: AbstractLogicalSpace
description: AbstractLogicalSpace is the abstract superclass for all types of logical
  spaces. Logical space refers to spaces that are not bounded by physical surfaces
  but are defined according to thematic considerations.

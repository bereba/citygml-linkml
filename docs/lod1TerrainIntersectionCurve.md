...
# Slot: lod1TerrainIntersectionCurve 


_Relates to a 3D MultiCurve geometry that represents the terrain intersection curve of the physical space in Level of Detail 1._





URI: [citygml:lod1TerrainIntersectionCurve](https://www.ogc.org/standards/citygml/lod1TerrainIntersectionCurve)
...
| Domain Of | [AbstractPhysicalSpace](AbstractPhysicalSpace.md) |
...
| Property | Value |
| --- | --- |
| Owner | [AbstractPhysicalSpace](AbstractPhysicalSpace.md) |
...
| ---  | ---  |
| self | citygml:lod1TerrainIntersectionCurve |
| native | citygml:lod1TerrainIntersectionCurve |

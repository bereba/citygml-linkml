...
# Slot: adeOfAbstractConstruction 


_Augments AbstractConstruction with properties defined in an ADE._
...
| Property | Value |
| --- | --- |
| Range | [ADEOfAbstractConstruction](ADEOfAbstractConstruction.md) |

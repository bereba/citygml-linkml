...
# Slot: observationProperty 



URI: [citygml:observationProperty](https://www.ogc.org/standards/citygml/observationProperty)
...
| Domain Of | [SensorConnection](SensorConnection.md), [AbstractAtomicTimeseries](AbstractAtomicTimeseries.md) |
...
| ---  | ---  |
| self | citygml:observationProperty |
| native | citygml:observationProperty |

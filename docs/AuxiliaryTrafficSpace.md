...
_An AuxiliaryTrafficSpace is a space within the transportation space not intended for traffic purposes._
...
```mermaid
 classDiagram
    ...
    click AuxiliaryTrafficSpace href "../AuxiliaryTrafficSpace/"
      AbstractUnoccupiedSpace <|-- AuxiliaryTrafficSpace
        click AbstractUnoccupiedSpace href "../AbstractUnoccupiedSpace/"
      
      AuxiliaryTrafficSpace : adeOfAbstractCityObject
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AuxiliaryTrafficSpace : adeOfAbstractFeature
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AuxiliaryTrafficSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AuxiliaryTrafficSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AuxiliaryTrafficSpace : adeOfAbstractSpace
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AuxiliaryTrafficSpace : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        click ADEOfAbstractUnoccupiedSpace href "../ADEOfAbstractUnoccupiedSpace/"
    

        
      AuxiliaryTrafficSpace : adeOfAuxiliaryTrafficSpace
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ADEOfAuxiliaryTrafficSpace : adeOfAuxiliaryTrafficSpace
        click ADEOfAuxiliaryTrafficSpace href "../ADEOfAuxiliaryTrafficSpace/"
    

        
      AuxiliaryTrafficSpace : appearance
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AuxiliaryTrafficSpace : area
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AuxiliaryTrafficSpace : boundary
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AuxiliaryTrafficArea : boundary
        click AuxiliaryTrafficArea href "../AuxiliaryTrafficArea/"
    

        
      AuxiliaryTrafficSpace : class
        
          
    
        
        
        AuxiliaryTrafficSpace --> "0..1" AuxiliaryTrafficSpaceClassValue : class
        click AuxiliaryTrafficSpaceClassValue href "../AuxiliaryTrafficSpaceClassValue/"
    

        
      AuxiliaryTrafficSpace : creationDate
        
      AuxiliaryTrafficSpace : description
        
      AuxiliaryTrafficSpace : dynamizer
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AuxiliaryTrafficSpace : externalReference
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AuxiliaryTrafficSpace : featureID
        
          
    
        
        
        AuxiliaryTrafficSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AuxiliaryTrafficSpace : function
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AuxiliaryTrafficSpaceFunctionValue : function
        click AuxiliaryTrafficSpaceFunctionValue href "../AuxiliaryTrafficSpaceFunctionValue/"
    

        
      AuxiliaryTrafficSpace : generalizesTo
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AuxiliaryTrafficSpace : genericAttribute
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AuxiliaryTrafficSpace : granularity
        
          
    
        
        
        AuxiliaryTrafficSpace --> "1" GranularityValue : granularity
        click GranularityValue href "../GranularityValue/"
    

        
      AuxiliaryTrafficSpace : identifier
        
      AuxiliaryTrafficSpace : lod0MultiCurve
        
      AuxiliaryTrafficSpace : lod0MultiSurface
        
      AuxiliaryTrafficSpace : lod0Point
        
      AuxiliaryTrafficSpace : lod1Solid
        
      AuxiliaryTrafficSpace : lod1TerrainIntersectionCurve
        
      AuxiliaryTrafficSpace : lod2MultiCurve
        
      AuxiliaryTrafficSpace : lod2MultiSurface
        
      AuxiliaryTrafficSpace : lod2Solid
        
      AuxiliaryTrafficSpace : lod2TerrainIntersectionCurve
        
      AuxiliaryTrafficSpace : lod3MultiCurve
        
      AuxiliaryTrafficSpace : lod3MultiSurface
        
      AuxiliaryTrafficSpace : lod3Solid
        
      AuxiliaryTrafficSpace : lod3TerrainIntersectionCurve
        
      AuxiliaryTrafficSpace : name
        
      AuxiliaryTrafficSpace : pointCloud
        
          
    
        
        
        AuxiliaryTrafficSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AuxiliaryTrafficSpace : relatedTo
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AuxiliaryTrafficSpace : relativeToTerrain
        
          
    
        
        
        AuxiliaryTrafficSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AuxiliaryTrafficSpace : relativeToWater
        
          
    
        
        
        AuxiliaryTrafficSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AuxiliaryTrafficSpace : spaceType
        
          
    
        
        
        AuxiliaryTrafficSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AuxiliaryTrafficSpace : terminationDate
        
      AuxiliaryTrafficSpace : usage
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" AuxiliaryTrafficSpaceUsageValue : usage
        click AuxiliaryTrafficSpaceUsageValue href "../AuxiliaryTrafficSpaceUsageValue/"
    

        
      AuxiliaryTrafficSpace : validFrom
        
      AuxiliaryTrafficSpace : validTo
        
      AuxiliaryTrafficSpace : volume
        
          
    
        
        
        AuxiliaryTrafficSpace --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [AuxiliaryTrafficSpaceClassValue](AuxiliaryTrafficSpaceClassValue.md) | Indicates the specific type of the AuxiliaryTrafficSpace | direct |
| [function](function.md) | * <br/> [AuxiliaryTrafficSpaceFunctionValue](AuxiliaryTrafficSpaceFunctionValue.md) | Specifies the intended purposes of the AuxiliaryTrafficSpace | direct |
| [usage](usage.md) | * <br/> [AuxiliaryTrafficSpaceUsageValue](AuxiliaryTrafficSpaceUsageValue.md) | Specifies the actual uses of the AuxiliaryTrafficSpace | direct |
| [granularity](granularity.md) | 1 <br/> [GranularityValue](GranularityValue.md) | Defines whether auxiliary traffic spaces are represented by individual ways o... | direct |
| [adeOfAuxiliaryTrafficSpace](adeOfAuxiliaryTrafficSpace.md) | * <br/> [ADEOfAuxiliaryTrafficSpace](ADEOfAuxiliaryTrafficSpace.md) | Augments the AuxiliaryTrafficSpace with properties defined in an ADE | direct |
| [boundary](boundary.md) | * <br/> [AuxiliaryTrafficArea](AuxiliaryTrafficArea.md) |  | direct |
...
| ---  | --- | --- | --- |
| [AbstractTransportationSpace](AbstractTransportationSpace.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Intersection](Intersection.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Railway](Railway.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Road](Road.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Section](Section.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Square](Square.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Track](Track.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
| [Waterway](Waterway.md) | [auxiliaryTrafficSpace](auxiliaryTrafficSpace.md) | range | [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md) |
...
description: An AuxiliaryTrafficSpace is a space within the transportation space not
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the AuxiliaryTrafficSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: AuxiliaryTrafficSpaceClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the AuxiliaryTrafficSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: AuxiliaryTrafficSpaceFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the AuxiliaryTrafficSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: AuxiliaryTrafficSpaceUsageValue
    required: false
    multivalued: true
  granularity:
    name: granularity
    description: Defines whether auxiliary traffic spaces are represented by individual
      ways or by individual lanes, depending on the desired level of spatial and semantic
      decomposition.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - AuxiliaryTrafficSpace
    - TrafficSpace
    range: GranularityValue
    required: true
    multivalued: false
  adeOfAuxiliaryTrafficSpace:
    name: adeOfAuxiliaryTrafficSpace
    description: Augments the AuxiliaryTrafficSpace with properties defined in an
      ADE.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - AuxiliaryTrafficSpace
    range: ADEOfAuxiliaryTrafficSpace
    required: false
    multivalued: true
  boundary:
    name: boundary
...
attributes:
  ...
  adeOfAuxiliaryTrafficSpace:
    ...
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    alias: adeOfAuxiliaryTrafficSpace
    owner: AuxiliaryTrafficSpace
    domain_of:
    - AuxiliaryTrafficSpace
    range: ADEOfAuxiliaryTrafficSpace

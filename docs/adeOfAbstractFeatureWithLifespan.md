...
# Slot: adeOfAbstractFeatureWithLifespan 


_Augments AbstractFeatureWithLifespan with properties defined in an ADE._





URI: [citygml:adeOfAbstractFeatureWithLifespan](https://www.ogc.org/standards/citygml/adeOfAbstractFeatureWithLifespan)
...
| [AbstractFeatureWithLifespan](AbstractFeatureWithLifespan.md) | AbstractFeatureWithLifespan is the base class for all CityGML features |  no  |
...
| [AbstractSpace](AbstractSpace.md) | AbstractSpace is the abstract superclass for all types of spaces |  no  |
...
| [AbstractCityObject](AbstractCityObject.md) | AbstractCityObject is the abstract superclass of all thematic classes within ... |  no  |
...
| [AbstractPhysicalSpace](AbstractPhysicalSpace.md) | AbstractPhysicalSpace is the abstract superclass for all types of physical sp... |  no  |
...
| [AbstractAppearance](AbstractAppearance.md) | AbstractAppearance is the abstract superclass to represent any kind of appear... |  no  |
...
| Property | Value |
| --- | --- |
| Range | [ADEOfAbstractFeatureWithLifespan](ADEOfAbstractFeatureWithLifespan.md) |
| Domain Of | [AbstractFeatureWithLifespan](AbstractFeatureWithLifespan.md) |
...
| Property | Value |
| --- | --- |
| Owner | [AbstractFeatureWithLifespan](AbstractFeatureWithLifespan.md) |
...
| ---  | ---  |
| self | citygml:adeOfAbstractFeatureWithLifespan |
| native | citygml:adeOfAbstractFeatureWithLifespan |
...
description: Augments AbstractFeatureWithLifespan with properties defined in an ADE.

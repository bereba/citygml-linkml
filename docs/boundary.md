...
URI: [citygml:boundary](https://www.ogc.org/standards/citygml/boundary)
Alias: boundary
...
| Domain Of | [AbstractConstruction](AbstractConstruction.md), [AbstractConstructiveElement](AbstractConstructiveElement.md), [AbstractInstallation](AbstractInstallation.md), [Door](Door.md), [Window](Window.md), [BridgeRoom](BridgeRoom.md), [BuildingRoom](BuildingRoom.md), [Storey](Storey.md), [AbstractSpace](AbstractSpace.md), [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md), [Hole](Hole.md), [TrafficSpace](TrafficSpace.md), [HollowSpace](HollowSpace.md), [WaterBody](WaterBody.md) |
...
| ---  | ---  |
| self | citygml:boundary |
| native | citygml:boundary |

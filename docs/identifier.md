...
URI: [citygml:identifier](https://www.ogc.org/standards/citygml/identifier)
Alias: identifier
...
| Domain Of | [AbstractFeature](AbstractFeature.md) |
...
| Property | Value |
| --- | --- |
| Owner | [AbstractFeature](AbstractFeature.md) |
...
| ---  | ---  |
| self | citygml:identifier |
| native | citygml:identifier |

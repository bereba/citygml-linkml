...
_Indicates the date at which a CityGML feature was added to the CityModel._





URI: [citygml:creationDate](https://www.ogc.org/standards/citygml/creationDate)
Alias: creationDate
...
| ---  | ---  |
| self | citygml:creationDate |
| native | citygml:creationDate |

...
_A GenericLogicalSpace is a space that is not represented by any explicitly modeled AbstractLogicalSpace subclass within CityGML._





URI: [citygml:GenericLogicalSpace](https://www.ogc.org/standards/citygml/GenericLogicalSpace)
...
```mermaid
 classDiagram
    class GenericLogicalSpace
    click GenericLogicalSpace href "../GenericLogicalSpace/"
      AbstractLogicalSpace <|-- GenericLogicalSpace
        click AbstractLogicalSpace href "../AbstractLogicalSpace/"
      
      GenericLogicalSpace : adeOfAbstractCityObject
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      GenericLogicalSpace : adeOfAbstractFeature
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      GenericLogicalSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      GenericLogicalSpace : adeOfAbstractLogicalSpace
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfAbstractLogicalSpace : adeOfAbstractLogicalSpace
        click ADEOfAbstractLogicalSpace href "../ADEOfAbstractLogicalSpace/"
    

        
      GenericLogicalSpace : adeOfAbstractSpace
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      GenericLogicalSpace : adeOfGenericLogicalSpace
        
          
    
        
        
        GenericLogicalSpace --> "*" ADEOfGenericLogicalSpace : adeOfGenericLogicalSpace
        click ADEOfGenericLogicalSpace href "../ADEOfGenericLogicalSpace/"
    

        
      GenericLogicalSpace : appearance
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      GenericLogicalSpace : area
        
          
    
        
        
        GenericLogicalSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      GenericLogicalSpace : boundary
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      GenericLogicalSpace : class
        
          
    
        
        
        GenericLogicalSpace --> "0..1" GenericLogicalSpaceClassValue : class
        click GenericLogicalSpaceClassValue href "../GenericLogicalSpaceClassValue/"
    

        
      GenericLogicalSpace : creationDate
        
      GenericLogicalSpace : description
        
      GenericLogicalSpace : dynamizer
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      GenericLogicalSpace : externalReference
        
          
    
        
        
        GenericLogicalSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      GenericLogicalSpace : featureID
        
          
    
        
        
        GenericLogicalSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      GenericLogicalSpace : function
        
          
    
        
        
        GenericLogicalSpace --> "*" GenericLogicalSpaceFunctionValue : function
        click GenericLogicalSpaceFunctionValue href "../GenericLogicalSpaceFunctionValue/"
    

        
      GenericLogicalSpace : generalizesTo
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericLogicalSpace : genericAttribute
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      GenericLogicalSpace : identifier
        
      GenericLogicalSpace : lod0MultiCurve
        
      GenericLogicalSpace : lod0MultiSurface
        
      GenericLogicalSpace : lod0Point
        
      GenericLogicalSpace : lod1Solid
        
      GenericLogicalSpace : lod2MultiCurve
        
      GenericLogicalSpace : lod2MultiSurface
        
      GenericLogicalSpace : lod2Solid
        
      GenericLogicalSpace : lod3MultiCurve
        
      GenericLogicalSpace : lod3MultiSurface
        
      GenericLogicalSpace : lod3Solid
        
      GenericLogicalSpace : name
        
      GenericLogicalSpace : relatedTo
        
          
    
        
        
        GenericLogicalSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericLogicalSpace : relativeToTerrain
        
          
    
        
        
        GenericLogicalSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      GenericLogicalSpace : relativeToWater
        
          
    
        
        
        GenericLogicalSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      GenericLogicalSpace : spaceType
        
          
    
        
        
        GenericLogicalSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      GenericLogicalSpace : terminationDate
      ...
      GenericLogicalSpace : usage
        ...
        GenericLogicalSpace --> "*" GenericLogicalSpaceUsageValue : usage
        click GenericLogicalSpaceUsageValue href "../GenericLogicalSpaceUsageValue/"
    

        
      GenericLogicalSpace : validFrom
        
      GenericLogicalSpace : validTo
        
      GenericLogicalSpace : volume
        
          
    
        
        
        GenericLogicalSpace --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [GenericLogicalSpaceClassValue](GenericLogicalSpaceClassValue.md) | Indicates the specific type of the GenericLogicalSpace | direct |
| [function](function.md) | * <br/> [GenericLogicalSpaceFunctionValue](GenericLogicalSpaceFunctionValue.md) | Specifies the intended purposes of the GenericLogicalSpace | direct |
| [usage](usage.md) | * <br/> [GenericLogicalSpaceUsageValue](GenericLogicalSpaceUsageValue.md) | Specifies the actual uses of the GenericLogicalSpace | direct |
| [adeOfGenericLogicalSpace](adeOfGenericLogicalSpace.md) | * <br/> [ADEOfGenericLogicalSpace](ADEOfGenericLogicalSpace.md) | Augments the GenericLogicalSpace with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:GenericLogicalSpace |
| native | citygml:GenericLogicalSpace |
...
description: A GenericLogicalSpace is a space that is not represented by any explicitly
  modeled AbstractLogicalSpace subclass within CityGML.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the GenericLogicalSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: GenericLogicalSpaceClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the GenericLogicalSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericLogicalSpaceFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the GenericLogicalSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericLogicalSpaceUsageValue
    required: false
    multivalued: true
  adeOfGenericLogicalSpace:
    name: adeOfGenericLogicalSpace
    description: Augments the GenericLogicalSpace with properties defined in an ADE.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - GenericLogicalSpace
    range: ADEOfGenericLogicalSpace
    required: false
    multivalued: true
...
attributes:
  ...
  adeOfGenericLogicalSpace:
    ...
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    alias: adeOfGenericLogicalSpace
    owner: GenericLogicalSpace
    domain_of:
    - GenericLogicalSpace
    range: ADEOfGenericLogicalSpace

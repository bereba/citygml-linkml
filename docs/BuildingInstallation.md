...
_A BuildingInstallation is a permanent part of a Building (inside and/or outside) which has not the significance of a BuildingPart. Examples are stairs, antennas, balconies or small roofs._
...
```mermaid
 classDiagram
    ...
    click BuildingInstallation href "../BuildingInstallation/"
      ...
      BuildingInstallation : adeOfAbstractCityObject
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      BuildingInstallation : adeOfAbstractFeature
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      BuildingInstallation : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      BuildingInstallation : adeOfAbstractInstallation
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractInstallation : adeOfAbstractInstallation
        click ADEOfAbstractInstallation href "../ADEOfAbstractInstallation/"
    

        
      BuildingInstallation : adeOfAbstractOccupiedSpace
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      BuildingInstallation : adeOfAbstractPhysicalSpace
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      BuildingInstallation : adeOfAbstractSpace
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      BuildingInstallation : adeOfBuildingInstallation
        
          
    
        
        
        BuildingInstallation --> "*" ADEOfBuildingInstallation : adeOfBuildingInstallation
        click ADEOfBuildingInstallation href "../ADEOfBuildingInstallation/"
    

        
      BuildingInstallation : appearance
        
          
    
        
        
        BuildingInstallation --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      BuildingInstallation : area
        
          
    
        
        
        BuildingInstallation --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      BuildingInstallation : boundary
        
          
    
        
        
        BuildingInstallation --> "*" AbstractThematicSurface : boundary
      ...
      BuildingInstallation : class
        ...
        BuildingInstallation --> "0..1" BuildingInstallationClassValue : class
        click BuildingInstallationClassValue href "../BuildingInstallationClassValue/"
    

        
      BuildingInstallation : creationDate
        
      BuildingInstallation : description
        
      BuildingInstallation : dynamizer
        
          
    
        
        
        BuildingInstallation --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      BuildingInstallation : externalReference
        
          
    
        
        
        BuildingInstallation --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      BuildingInstallation : featureID
        
          
    
        
        
        BuildingInstallation --> "1" ID : featureID
        click ID href "../ID/"
    

        
      BuildingInstallation : function
        
          
    
        
        
        BuildingInstallation --> "*" BuildingInstallationFunctionValue : function
        click BuildingInstallationFunctionValue href "../BuildingInstallationFunctionValue/"
    

        
      BuildingInstallation : generalizesTo
        
          
    
        
        
        BuildingInstallation --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      BuildingInstallation : genericAttribute
        
          
    
        
        
        BuildingInstallation --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      BuildingInstallation : identifier
        
      BuildingInstallation : lod0MultiCurve
        
      BuildingInstallation : lod0MultiSurface
        
      BuildingInstallation : lod0Point
        
      BuildingInstallation : lod1ImplicitRepresentation
        
          
    
        
        
        BuildingInstallation --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      BuildingInstallation : lod1Solid
        
      BuildingInstallation : lod1TerrainIntersectionCurve
        
      BuildingInstallation : lod2ImplicitRepresentation
        
          
    
        
        
        BuildingInstallation --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      BuildingInstallation : lod2MultiCurve
        
      BuildingInstallation : lod2MultiSurface
        
      BuildingInstallation : lod2Solid
        
      BuildingInstallation : lod2TerrainIntersectionCurve
        
      BuildingInstallation : lod3ImplicitRepresentation
        
          
    
        
        
        BuildingInstallation --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      BuildingInstallation : lod3MultiCurve
        
      BuildingInstallation : lod3MultiSurface
        
      BuildingInstallation : lod3Solid
        
      BuildingInstallation : lod3TerrainIntersectionCurve
        
      BuildingInstallation : name
        
      BuildingInstallation : pointCloud
        
          
    
        
        
        BuildingInstallation --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      BuildingInstallation : relatedTo
        
          
    
        
        
        BuildingInstallation --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      BuildingInstallation : relationToConstruction
        
          
    
        
        
        BuildingInstallation --> "0..1" RelationToConstruction : relationToConstruction
        click RelationToConstruction href "../RelationToConstruction/"
    

        
      BuildingInstallation : relativeToTerrain
        
          
    
        
        
        BuildingInstallation --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      BuildingInstallation : relativeToWater
        
          
    
        
        
        BuildingInstallation --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      BuildingInstallation : spaceType
        
          
    
        
        
        BuildingInstallation --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      BuildingInstallation : terminationDate
      ...
      BuildingInstallation : usage
        ...
        BuildingInstallation --> "*" BuildingInstallationUsageValue : usage
        click BuildingInstallationUsageValue href "../BuildingInstallationUsageValue/"
    

        
      BuildingInstallation : validFrom
        
      BuildingInstallation : validTo
        
      BuildingInstallation : volume
        
          
    
        
        
        BuildingInstallation --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [BuildingInstallationClassValue](BuildingInstallationClassValue.md) | Indicates the specific type of the BuildingInstallation | direct |
| [function](function.md) | * <br/> [BuildingInstallationFunctionValue](BuildingInstallationFunctionValue.md) | Specifies the intended purposes of the BuildingInstallation | direct |
| [usage](usage.md) | * <br/> [BuildingInstallationUsageValue](BuildingInstallationUsageValue.md) | Specifies the actual uses of the BuildingInstallation | direct |
| [adeOfBuildingInstallation](adeOfBuildingInstallation.md) | * <br/> [ADEOfBuildingInstallation](ADEOfBuildingInstallation.md) | Augments the BuildingInstallation with properties defined in an ADE | direct |
...
| ---  | --- | --- | --- |
| [AbstractBuilding](AbstractBuilding.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [AbstractBuildingSubdivision](AbstractBuildingSubdivision.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [Building](Building.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [BuildingPart](BuildingPart.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [BuildingRoom](BuildingRoom.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [BuildingUnit](BuildingUnit.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
| [Storey](Storey.md) | [buildingInstallation](buildingInstallation.md) | range | [BuildingInstallation](BuildingInstallation.md) |
...
description: A BuildingInstallation is a permanent part of a Building (inside and/or
  outside) which has not the significance of a BuildingPart. Examples are stairs,
  antennas, balconies or small roofs.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the BuildingInstallation.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: BuildingInstallationClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the BuildingInstallation.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: BuildingInstallationFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the BuildingInstallation.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: BuildingInstallationUsageValue
    required: false
    multivalued: true

...
URI: [citygml:description](https://www.ogc.org/standards/citygml/description)
Alias: description
...
| Domain Of | [ConstructionEvent](ConstructionEvent.md), [AbstractFeature](AbstractFeature.md) |
...
| ---  | ---  |
| self | citygml:description |
| native | citygml:description |

...
_A HoleSurface is a representation of the ground surface of a hole._





URI: [citygml:HoleSurface](https://www.ogc.org/standards/citygml/HoleSurface)
...
```mermaid
 classDiagram
    ...
    click HoleSurface href "../HoleSurface/"
      ...
      HoleSurface : adeOfAbstractCityObject
        
          
    
        
        
        HoleSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      HoleSurface : adeOfAbstractFeature
        
          
    
        
        
        HoleSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      HoleSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        HoleSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      HoleSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        HoleSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      HoleSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        HoleSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      HoleSurface : adeOfHoleSurface
        
          
    
        
        
        HoleSurface --> "*" ADEOfHoleSurface : adeOfHoleSurface
        click ADEOfHoleSurface href "../ADEOfHoleSurface/"
    

        
      HoleSurface : appearance
        
          
    
        
        
        HoleSurface --> "*" AbstractAppearance : appearance
      ...
      HoleSurface : area
        ...
        HoleSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      HoleSurface : creationDate
        
      HoleSurface : description
        
      HoleSurface : dynamizer
        
          
    
        
        
        HoleSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      HoleSurface : externalReference
        
          
    
        
        
        HoleSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      HoleSurface : featureID
        
          
    
        
        
        HoleSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      HoleSurface : generalizesTo
        
          
    
        
        
        HoleSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      HoleSurface : genericAttribute
        
          
    
        
        
        HoleSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      HoleSurface : identifier
        
      HoleSurface : lod0MultiCurve
        
      HoleSurface : lod0MultiSurface
        
      HoleSurface : lod1MultiSurface
        
      HoleSurface : lod2MultiSurface
        
      HoleSurface : lod3MultiSurface
        
      HoleSurface : name
        
      HoleSurface : pointCloud
        
          
    
        
        
        HoleSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      HoleSurface : relatedTo
        
          
    
        
        
        HoleSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      HoleSurface : relativeToTerrain
        
          
    
        
        
        HoleSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      HoleSurface : relativeToWater
        
          
    
        
        
        HoleSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      HoleSurface : terminationDate
        
      HoleSurface : validFrom
...
| ---  | --- | --- | --- |
| [adeOfHoleSurface](adeOfHoleSurface.md) | * <br/> [ADEOfHoleSurface](ADEOfHoleSurface.md) | Augments the HoleSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:HoleSurface |
| native | citygml:HoleSurface |
...
```yaml
name: HoleSurface
description: A HoleSurface is a representation of the ground surface of a hole.

...
_An OtherConstruction is a construction that is not covered by any of the other subclasses of AbstractConstruction._





URI: [citygml:OtherConstruction](https://www.ogc.org/standards/citygml/OtherConstruction)
...
```mermaid
 classDiagram
    ...
    click OtherConstruction href "../OtherConstruction/"
      ...
      OtherConstruction : adeOfAbstractCityObject
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      OtherConstruction : adeOfAbstractConstruction
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractConstruction : adeOfAbstractConstruction
        click ADEOfAbstractConstruction href "../ADEOfAbstractConstruction/"
    

        
      OtherConstruction : adeOfAbstractFeature
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      OtherConstruction : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      OtherConstruction : adeOfAbstractOccupiedSpace
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      OtherConstruction : adeOfAbstractPhysicalSpace
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      OtherConstruction : adeOfAbstractSpace
        
          
    
        
        
        OtherConstruction --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      OtherConstruction : adeOfOtherConstruction
        
          
    
        
        
        OtherConstruction --> "*" ADEOfOtherConstruction : adeOfOtherConstruction
        click ADEOfOtherConstruction href "../ADEOfOtherConstruction/"
    

        
      OtherConstruction : appearance
        
          
    
        
        
        OtherConstruction --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      OtherConstruction : area
        
          
    
        
        
        OtherConstruction --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      OtherConstruction : boundary
        
          
    
        
        
        OtherConstruction --> "*" AbstractThematicSurface : boundary
        click AbstractThematicSurface href "../AbstractThematicSurface/"
    

        
      OtherConstruction : class
        
          
    
        
        
        OtherConstruction --> "0..1" OtherConstructionClassValue : class
        click OtherConstructionClassValue href "../OtherConstructionClassValue/"
    

        
      OtherConstruction : conditionOfConstruction
        
          
    
        
        
        OtherConstruction --> "0..1" ConditionOfConstructionValue : conditionOfConstruction
        click ConditionOfConstructionValue href "../ConditionOfConstructionValue/"
    

        
      OtherConstruction : constructionEvent
        
          
    
        
        
        OtherConstruction --> "*" ConstructionEvent : constructionEvent
        click ConstructionEvent href "../ConstructionEvent/"
    

        
      OtherConstruction : creationDate
        
      OtherConstruction : dateOfConstruction
        
      OtherConstruction : dateOfDemolition
        
      OtherConstruction : description
        
      OtherConstruction : dynamizer
        
          
    
        
        
        OtherConstruction --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      OtherConstruction : elevation
        
          
    
        
        
        OtherConstruction --> "*" Elevation : elevation
        click Elevation href "../Elevation/"
    

        
      OtherConstruction : externalReference
        
          
    
        
        
        OtherConstruction --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      OtherConstruction : featureID
        
          
    
        
        
        OtherConstruction --> "1" ID : featureID
        click ID href "../ID/"
    

        
      OtherConstruction : function
        
          
    
        
        
        OtherConstruction --> "*" OtherConstructionFunctionValue : function
        click OtherConstructionFunctionValue href "../OtherConstructionFunctionValue/"
    

        
      OtherConstruction : generalizesTo
        
          
    
        
        
        OtherConstruction --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      OtherConstruction : genericAttribute
        
          
    
        
        
        OtherConstruction --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      OtherConstruction : height
        
          
    
        
        
        OtherConstruction --> "*" Height : height
        click Height href "../Height/"
    

        
      OtherConstruction : identifier
        
      OtherConstruction : lod0MultiCurve
        
      OtherConstruction : lod0MultiSurface
        
      OtherConstruction : lod0Point
        
      OtherConstruction : lod1ImplicitRepresentation
        
          
    
        
        
        OtherConstruction --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      OtherConstruction : lod1Solid
        
      OtherConstruction : lod1TerrainIntersectionCurve
        
      OtherConstruction : lod2ImplicitRepresentation
        
          
    
        
        
        OtherConstruction --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      OtherConstruction : lod2MultiCurve
        
      OtherConstruction : lod2MultiSurface
        
      OtherConstruction : lod2Solid
        
      OtherConstruction : lod2TerrainIntersectionCurve
        
      OtherConstruction : lod3ImplicitRepresentation
        
          
    
        
        
        OtherConstruction --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      OtherConstruction : lod3MultiCurve
        
      OtherConstruction : lod3MultiSurface
        
      OtherConstruction : lod3Solid
        
      OtherConstruction : lod3TerrainIntersectionCurve
        
      OtherConstruction : name
        
      OtherConstruction : occupancy
        
          
    
        
        
        OtherConstruction --> "*" Occupancy : occupancy
        click Occupancy href "../Occupancy/"
    

        
      OtherConstruction : pointCloud
        
          
    
        
        
        OtherConstruction --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      OtherConstruction : relatedTo
        
          
    
        
        
        OtherConstruction --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      OtherConstruction : relativeToTerrain
        
          
    
        
        
        OtherConstruction --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      OtherConstruction : relativeToWater
        
          
    
        
        
        OtherConstruction --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      OtherConstruction : spaceType
        
          
    
        
        
        OtherConstruction --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      OtherConstruction : terminationDate
        
      OtherConstruction : usage
        
          
    
        
        
        OtherConstruction --> "*" OtherConstructionUsageValue : usage
        click OtherConstructionUsageValue href "../OtherConstructionUsageValue/"
    

        
      OtherConstruction : validFrom
        
      OtherConstruction : validTo
        
      OtherConstruction : volume
        
          
    
        
        
        OtherConstruction --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [OtherConstructionClassValue](OtherConstructionClassValue.md) | Indicates the specific type of the OtherConstruction | direct |
| [function](function.md) | * <br/> [OtherConstructionFunctionValue](OtherConstructionFunctionValue.md) | Specifies the intended purposes of the OtherConstruction | direct |
| [usage](usage.md) | * <br/> [OtherConstructionUsageValue](OtherConstructionUsageValue.md) | Specifies the actual uses of the OtherConstruction | direct |
| [adeOfOtherConstruction](adeOfOtherConstruction.md) | * <br/> [ADEOfOtherConstruction](ADEOfOtherConstruction.md) | Augments the OtherConstruction with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:OtherConstruction |
| native | citygml:OtherConstruction |
...
description: An OtherConstruction is a construction that is not covered by any of
  the other subclasses of AbstractConstruction.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the OtherConstruction.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: OtherConstructionClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the OtherConstruction.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: OtherConstructionFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the OtherConstruction.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: OtherConstructionUsageValue
    required: false
    multivalued: true
  adeOfOtherConstruction:
    name: adeOfOtherConstruction
    description: Augments the OtherConstruction with properties defined in an ADE.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - OtherConstruction
    range: ADEOfOtherConstruction
    required: false
    multivalued: true

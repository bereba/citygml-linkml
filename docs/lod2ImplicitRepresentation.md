...
# Slot: lod2ImplicitRepresentation 


_Relates to an implicit geometry that represents the occupied space in Level of Detail 2._





URI: [citygml:lod2ImplicitRepresentation](https://www.ogc.org/standards/citygml/lod2ImplicitRepresentation)
...
| ---  | ---  |
| self | citygml:lod2ImplicitRepresentation |
| native | citygml:lod2ImplicitRepresentation |

...
# Slot: genericAttribute 



URI: [citygml:genericAttribute](https://www.ogc.org/standards/citygml/genericAttribute)
...
| Domain Of | [GenericAttributeSet](GenericAttributeSet.md), [AbstractCityObject](AbstractCityObject.md) |
...
| ---  | ---  |
| self | citygml:genericAttribute |
| native | citygml:genericAttribute |

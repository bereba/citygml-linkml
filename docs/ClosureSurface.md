...
_ClosureSurface is a special type of thematic surface used to close holes in volumetric objects. Closure surfaces are virtual (non-physical) surfaces._





URI: [citygml:ClosureSurface](https://www.ogc.org/standards/citygml/ClosureSurface)
...
```mermaid
 classDiagram
    ...
    click ClosureSurface href "../ClosureSurface/"
      ...
      ClosureSurface : adeOfAbstractCityObject
        
          
    
        
        
        ClosureSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      ClosureSurface : adeOfAbstractFeature
        
          
    
        
        
        ClosureSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      ClosureSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        ClosureSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      ClosureSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        ClosureSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      ClosureSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        ClosureSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      ClosureSurface : adeOfClosureSurface
        
          
    
        
        
        ClosureSurface --> "*" ADEOfClosureSurface : adeOfClosureSurface
        click ADEOfClosureSurface href "../ADEOfClosureSurface/"
    

        
      ClosureSurface : appearance
        
          
    
        
        
        ClosureSurface --> "*" AbstractAppearance : appearance
      ...
      ClosureSurface : area
        ...
        ClosureSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      ClosureSurface : creationDate
        
      ClosureSurface : description
        
      ClosureSurface : dynamizer
        
          
    
        
        
        ClosureSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      ClosureSurface : externalReference
        
          
    
        
        
        ClosureSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      ClosureSurface : featureID
        
          
    
        
        
        ClosureSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      ClosureSurface : generalizesTo
        
          
    
        
        
        ClosureSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      ClosureSurface : genericAttribute
        
          
    
        
        
        ClosureSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      ClosureSurface : identifier
        
      ClosureSurface : lod0MultiCurve
        
      ClosureSurface : lod0MultiSurface
        
      ClosureSurface : lod1MultiSurface
        
      ClosureSurface : lod2MultiSurface
        
      ClosureSurface : lod3MultiSurface
        
      ClosureSurface : name
        
      ClosureSurface : pointCloud
        
          
    
        
        
        ClosureSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      ClosureSurface : relatedTo
        
          
    
        
        
        ClosureSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      ClosureSurface : relativeToTerrain
        
          
    
        
        
        ClosureSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      ClosureSurface : relativeToWater
        
          
    
        
        
        ClosureSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      ClosureSurface : terminationDate
        
      ClosureSurface : validFrom
        
      ClosureSurface : validTo
...
| ---  | --- | --- | --- |
| [adeOfClosureSurface](adeOfClosureSurface.md) | * <br/> [ADEOfClosureSurface](ADEOfClosureSurface.md) | Augments the ClosureSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:ClosureSurface |
| native | citygml:ClosureSurface |
...
```yaml
name: ClosureSurface
description: ClosureSurface is a special type of thematic surface used to close holes
  in volumetric objects. Closure surfaces are virtual (non-physical) surfaces.

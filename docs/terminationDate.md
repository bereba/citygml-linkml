...
_Indicates the date at which a CityGML feature was removed from the CityModel._





URI: [citygml:terminationDate](https://www.ogc.org/standards/citygml/terminationDate)
...
| ---  | ---  |
| self | citygml:terminationDate |
| native | citygml:terminationDate |
...
description: Indicates the date at which a CityGML feature was removed from the CityModel.

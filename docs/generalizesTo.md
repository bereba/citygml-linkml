...
_Relates generalized representations of the same real-world object in different Levels of Detail to the city object. The direction of this relation is from the city object to the corresponding generalized city objects._





URI: [citygml:generalizesTo](https://www.ogc.org/standards/citygml/generalizesTo)
Alias: generalizesTo
...
| Domain Of | [AbstractCityObject](AbstractCityObject.md) |
...
| Property | Value |
| --- | --- |
| Owner | [AbstractCityObject](AbstractCityObject.md) |
...
| ---  | ---  |
| self | citygml:generalizesTo |
| native | citygml:generalizesTo |
...
```yaml
name: generalizesTo
description: Relates generalized representations of the same real-world object in
  different Levels of Detail to the city object. The direction of this relation is
  from the city object to the corresponding generalized city objects.

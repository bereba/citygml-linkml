...
_A Track is a small path mainly used by pedestrians. Tracks can be segmented into Sections and Intersections._





URI: [citygml:Track](https://www.ogc.org/standards/citygml/Track)
...
```mermaid
 classDiagram
    ...
    click Track href "../Track/"
      ...
      Track : adeOfAbstractCityObject
        
          
    
        
        
        Track --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      Track : adeOfAbstractFeature
        
          
    
        
        
        Track --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      Track : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        Track --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      Track : adeOfAbstractPhysicalSpace
        
          
    
        
        
        Track --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      Track : adeOfAbstractSpace
        
          
    
        
        
        Track --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      Track : adeOfAbstractTransportationSpace
        
          
    
        
        
        Track --> "*" ADEOfAbstractTransportationSpace : adeOfAbstractTransportationSpace
        click ADEOfAbstractTransportationSpace href "../ADEOfAbstractTransportationSpace/"
    

        
      Track : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        Track --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
      ...
      Track : adeOfTrack
        ...
        Track --> "*" ADEOfTrack : adeOfTrack
        click ADEOfTrack href "../ADEOfTrack/"
      ...
      Track : appearance
        ...
        Track --> "*" AbstractAppearance : appearance
      ...
      Track : area
        ...
        Track --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      Track : auxiliaryTrafficSpace
        
          
    
        
        
        Track --> "*" AuxiliaryTrafficSpace : auxiliaryTrafficSpace
      ...
      Track : boundary
        ...
        Track --> "*" AbstractSpaceBoundary : boundary
      ...
      Track : class
        ...
        Track --> "0..1" TrackClassValue : class
        click TrackClassValue href "../TrackClassValue/"
      ...
      Track : dynamizer
        ...
        Track --> "*" AbstractDynamizer : dynamizer
      ...
      Track : externalReference
        ...
        Track --> "*" ExternalReference : externalReference
      ...
      Track : function
        ...
        Track --> "*" TrackFunctionValue : function
        click TrackFunctionValue href "../TrackFunctionValue/"
      ...
      Track : generalizesTo
        ...
        Track --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Track : genericAttribute
        
          
    
        
        
        Track --> "*" AbstractGenericAttribute : genericAttribute
      ...
      Track : lod0MultiCurve
        
      Track : lod0MultiSurface
        
      Track : lod0Point
        
      Track : lod1Solid
        
      Track : lod1TerrainIntersectionCurve
        
      Track : lod2MultiCurve
        
      Track : lod2MultiSurface
        
      Track : lod2Solid
        
      Track : lod2TerrainIntersectionCurve
        
      Track : lod3MultiCurve
        
      Track : lod3MultiSurface
        
      Track : lod3Solid
        
      Track : lod3TerrainIntersectionCurve
      ...
      Track : pointCloud
        ...
        Track --> "0..1" AbstractPointCloud : pointCloud
      ...
      Track : relatedTo
        ...
        Track --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Track : relativeToTerrain
        
          
    
        
        
        Track --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      Track : relativeToWater
        
          
    
        
        
        Track --> "0..1" RelativeToWater : relativeToWater
      ...
      Track : spaceType
        ...
        Track --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      Track : terminationDate
        
      Track : trafficDirection
        
          
    
        
        
        Track --> "0..1" TrafficDirectionValue : trafficDirection
      ...
      Track : trafficSpace
        ...
        Track --> "*" TrafficSpace : trafficSpace
      ...
      Track : usage
        ...
        Track --> "*" TrackUsageValue : usage
        click TrackUsageValue href "../TrackUsageValue/"
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [TrackClassValue](TrackClassValue.md) | Indicates the specific type of the Track | direct |
| [function](function.md) | * <br/> [TrackFunctionValue](TrackFunctionValue.md) | Specifies the intended purposes of the Track | direct |
| [usage](usage.md) | * <br/> [TrackUsageValue](TrackUsageValue.md) | Specifies the actual uses of the Track | direct |
| [adeOfTrack](adeOfTrack.md) | * <br/> [ADEOfTrack](ADEOfTrack.md) | Augments the Track with properties defined in an ADE | direct |
| [intersection](intersection.md) | * <br/> [Intersection](Intersection.md) | Relates to the intersections that are part of the Track | direct |
| [section](section.md) | * <br/> [Section](Section.md) | Relates to the sections that are part of the Track | direct |
...
```yaml
name: Track
description: A Track is a small path mainly used by pedestrians. Tracks can be segmented
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the Track.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: TrackClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the Track.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: TrackFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the Track.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
  ...
  intersection:
    name: intersection
    description: Relates to the intersections that are part of the Track.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Railway
    - Road
  ...
  section:
    name: section
    description: Relates to the sections that are part of the Track.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Railway
    - Road

...
# Slot: relativeToTerrain 


_Describes the vertical position of the city object relative to the surrounding terrain._





URI: [citygml:relativeToTerrain](https://www.ogc.org/standards/citygml/relativeToTerrain)
...
| Property | Value |
| --- | --- |
| Range | [RelativeToTerrain](RelativeToTerrain.md) |
...
| ---  | ---  |
| self | citygml:relativeToTerrain |
| native | citygml:relativeToTerrain |
...
description: Describes the vertical position of the city object relative to the surrounding
  terrain.

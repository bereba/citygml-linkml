...
# Slot: lod1ImplicitRepresentation 


_Relates to an implicit geometry that represents the occupied space in Level of Detail 1._





URI: [citygml:lod1ImplicitRepresentation](https://www.ogc.org/standards/citygml/lod1ImplicitRepresentation)
...
| ---  | ---  |
| self | citygml:lod1ImplicitRepresentation |
| native | citygml:lod1ImplicitRepresentation |

...
URI: [citygml:class](https://www.ogc.org/standards/citygml/class)
Alias: class
...
| Domain Of | [Door](Door.md), [OtherConstruction](OtherConstruction.md), [Window](Window.md), [AbstractBridge](AbstractBridge.md), [BridgeConstructiveElement](BridgeConstructiveElement.md), [BridgeFurniture](BridgeFurniture.md), [BridgeInstallation](BridgeInstallation.md), [BridgeRoom](BridgeRoom.md), [AbstractBuilding](AbstractBuilding.md), [AbstractBuildingSubdivision](AbstractBuildingSubdivision.md), [BuildingConstructiveElement](BuildingConstructiveElement.md), [BuildingFurniture](BuildingFurniture.md), [BuildingInstallation](BuildingInstallation.md), [BuildingRoom](BuildingRoom.md), [CityFurniture](CityFurniture.md), [CityObjectGroup](CityObjectGroup.md), [GenericLogicalSpace](GenericLogicalSpace.md), [GenericOccupiedSpace](GenericOccupiedSpace.md), [GenericThematicSurface](GenericThematicSurface.md), [GenericUnoccupiedSpace](GenericUnoccupiedSpace.md), [LandUse](LandUse.md), [AuxiliaryTrafficArea](AuxiliaryTrafficArea.md), [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md), [ClearanceSpace](ClearanceSpace.md), [Hole](Hole.md), [Intersection](Intersection.md), [Marking](Marking.md), [Railway](Railway.md), [Road](Road.md), [Section](Section.md), [Square](Square.md), [Track](Track.md), [TrafficArea](TrafficArea.md), [TrafficSpace](TrafficSpace.md), [Waterway](Waterway.md), [AbstractTunnel](AbstractTunnel.md), [HollowSpace](HollowSpace.md), [TunnelConstructiveElement](TunnelConstructiveElement.md), [TunnelFurniture](TunnelFurniture.md), [TunnelInstallation](TunnelInstallation.md), [PlantCover](PlantCover.md), [SolitaryVegetationObject](SolitaryVegetationObject.md), [WaterBody](WaterBody.md) |

...
_AbstractUnoccupiedSpace is the abstract superclass for all types of physically unoccupied spaces. Unoccupied space refers to spaces that are entirely or mostly free of matter._
...
URI: [citygml:AbstractUnoccupiedSpace](https://www.ogc.org/standards/citygml/AbstractUnoccupiedSpace)
...
```mermaid
 classDiagram
    ...
    click AbstractUnoccupiedSpace href "../AbstractUnoccupiedSpace/"
      AbstractPhysicalSpace <|-- AbstractUnoccupiedSpace
      ...
      AbstractUnoccupiedSpace <|-- ClearanceSpace
        click ClearanceSpace href "../ClearanceSpace/"
      AbstractUnoccupiedSpace <|-- Hole
      ...
      AbstractUnoccupiedSpace : adeOfAbstractCityObject
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractUnoccupiedSpace : adeOfAbstractFeature
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractUnoccupiedSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractUnoccupiedSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractUnoccupiedSpace : adeOfAbstractSpace
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        click ADEOfAbstractUnoccupiedSpace href "../ADEOfAbstractUnoccupiedSpace/"
    

        
      AbstractUnoccupiedSpace : appearance
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractUnoccupiedSpace : area
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractUnoccupiedSpace : boundary
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      AbstractUnoccupiedSpace : creationDate
        
      AbstractUnoccupiedSpace : description
        
      AbstractUnoccupiedSpace : dynamizer
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractUnoccupiedSpace : externalReference
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractUnoccupiedSpace : featureID
        
          
    
        
        
        AbstractUnoccupiedSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractUnoccupiedSpace : generalizesTo
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractUnoccupiedSpace : genericAttribute
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractUnoccupiedSpace : identifier
        
      AbstractUnoccupiedSpace : lod0MultiCurve
        
      AbstractUnoccupiedSpace : lod0MultiSurface
        
      AbstractUnoccupiedSpace : lod0Point
        
      AbstractUnoccupiedSpace : lod1Solid
        
      AbstractUnoccupiedSpace : lod1TerrainIntersectionCurve
        
      AbstractUnoccupiedSpace : lod2MultiCurve
        
      AbstractUnoccupiedSpace : lod2MultiSurface
        
      AbstractUnoccupiedSpace : lod2Solid
        
      AbstractUnoccupiedSpace : lod2TerrainIntersectionCurve
        
      AbstractUnoccupiedSpace : lod3MultiCurve
        
      AbstractUnoccupiedSpace : lod3MultiSurface
        
      AbstractUnoccupiedSpace : lod3Solid
        
      AbstractUnoccupiedSpace : lod3TerrainIntersectionCurve
        
      AbstractUnoccupiedSpace : name
        
      AbstractUnoccupiedSpace : pointCloud
        
          
    
        
        
        AbstractUnoccupiedSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractUnoccupiedSpace : relatedTo
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractUnoccupiedSpace : relativeToTerrain
        
          
    
        
        
        AbstractUnoccupiedSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractUnoccupiedSpace : relativeToWater
        
          
    
        
        
        AbstractUnoccupiedSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractUnoccupiedSpace : spaceType
        
          
    
        
        
        AbstractUnoccupiedSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractUnoccupiedSpace : terminationDate
        
      AbstractUnoccupiedSpace : validFrom
        
      AbstractUnoccupiedSpace : validTo
        
      AbstractUnoccupiedSpace : volume
        
          
    
        
        
        AbstractUnoccupiedSpace --> "*" QualifiedVolume : volume
            ...
            * [AbstractSpace](AbstractSpace.md)
                * [AbstractPhysicalSpace](AbstractPhysicalSpace.md)
                    * **AbstractUnoccupiedSpace**
                        * [BridgeRoom](BridgeRoom.md)
                        * [BuildingRoom](BuildingRoom.md)
                        * [GenericUnoccupiedSpace](GenericUnoccupiedSpace.md)
                        * [AbstractTransportationSpace](AbstractTransportationSpace.md)
                        * [AuxiliaryTrafficSpace](AuxiliaryTrafficSpace.md)
                        * [ClearanceSpace](ClearanceSpace.md)
                        * [Hole](Hole.md)
                        * [TrafficSpace](TrafficSpace.md)
                        * [HollowSpace](HollowSpace.md)
...
| ---  | --- | --- | --- |
| [adeOfAbstractUnoccupiedSpace](adeOfAbstractUnoccupiedSpace.md) | * <br/> [ADEOfAbstractUnoccupiedSpace](ADEOfAbstractUnoccupiedSpace.md) | Augments AbstractUnoccupiedSpace with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:AbstractUnoccupiedSpace |
| native | citygml:AbstractUnoccupiedSpace |
...
<details>
```yaml
name: AbstractUnoccupiedSpace
description: AbstractUnoccupiedSpace is the abstract superclass for all types of physically
  unoccupied spaces. Unoccupied space refers to spaces that are entirely or mostly
  free of matter.

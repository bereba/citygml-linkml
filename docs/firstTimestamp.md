...
_Specifies the beginning of the timeseries._





URI: [citygml:firstTimestamp](https://www.ogc.org/standards/citygml/firstTimestamp)
...
| ---  | ---  |
| self | citygml:firstTimestamp |
| native | citygml:firstTimestamp |

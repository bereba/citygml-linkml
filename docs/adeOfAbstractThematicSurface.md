...
# Slot: adeOfAbstractThematicSurface 


_Augments AbstractThematicSurface with properties defined in an ADE._
...
| Property | Value |
| --- | --- |
| Range | [ADEOfAbstractThematicSurface](ADEOfAbstractThematicSurface.md) |

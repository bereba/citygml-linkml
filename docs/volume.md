...
URI: [citygml:volume](https://www.ogc.org/standards/citygml/volume)
Alias: volume
...
| Domain Of | [QualifiedVolume](QualifiedVolume.md), [AbstractSpace](AbstractSpace.md) |

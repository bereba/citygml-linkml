...
_Relates to a 3D Point geometry that represents the space in Level of Detail 0._





URI: [citygml:lod0Point](https://www.ogc.org/standards/citygml/lod0Point)
Alias: lod0Point
...
| ---  | ---  |
| self | citygml:lod0Point |
| native | citygml:lod0Point |
...
```yaml
name: lod0Point
description: Relates to a 3D Point geometry that represents the space in Level of
  Detail 0.

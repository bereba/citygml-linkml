...
_A GenericUnoccupiedSpace is a space that is not represented by any explicitly modeled AbstractUnoccupiedSpace subclass within CityGML._





URI: [citygml:GenericUnoccupiedSpace](https://www.ogc.org/standards/citygml/GenericUnoccupiedSpace)
...
```mermaid
 classDiagram
    class GenericUnoccupiedSpace
    click GenericUnoccupiedSpace href "../GenericUnoccupiedSpace/"
      AbstractUnoccupiedSpace <|-- GenericUnoccupiedSpace
        click AbstractUnoccupiedSpace href "../AbstractUnoccupiedSpace/"
      
      GenericUnoccupiedSpace : adeOfAbstractCityObject
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      GenericUnoccupiedSpace : adeOfAbstractFeature
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      GenericUnoccupiedSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      GenericUnoccupiedSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      GenericUnoccupiedSpace : adeOfAbstractSpace
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      GenericUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
        click ADEOfAbstractUnoccupiedSpace href "../ADEOfAbstractUnoccupiedSpace/"
    

        
      GenericUnoccupiedSpace : adeOfGenericUnoccupiedSpace
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ADEOfGenericUnoccupiedSpace : adeOfGenericUnoccupiedSpace
        click ADEOfGenericUnoccupiedSpace href "../ADEOfGenericUnoccupiedSpace/"
    

        
      GenericUnoccupiedSpace : appearance
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      GenericUnoccupiedSpace : area
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      GenericUnoccupiedSpace : boundary
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      GenericUnoccupiedSpace : class
        
          
    
        
        
        GenericUnoccupiedSpace --> "0..1" GenericUnoccupiedSpaceClassValue : class
        click GenericUnoccupiedSpaceClassValue href "../GenericUnoccupiedSpaceClassValue/"
    

        
      GenericUnoccupiedSpace : creationDate
        
      GenericUnoccupiedSpace : description
        
      GenericUnoccupiedSpace : dynamizer
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      GenericUnoccupiedSpace : externalReference
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      GenericUnoccupiedSpace : featureID
        
          
    
        
        
        GenericUnoccupiedSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      GenericUnoccupiedSpace : function
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" GenericUnoccupiedSpaceFunctionValue : function
        click GenericUnoccupiedSpaceFunctionValue href "../GenericUnoccupiedSpaceFunctionValue/"
    

        
      GenericUnoccupiedSpace : generalizesTo
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericUnoccupiedSpace : genericAttribute
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      GenericUnoccupiedSpace : identifier
        
      GenericUnoccupiedSpace : lod0MultiCurve
        
      GenericUnoccupiedSpace : lod0MultiSurface
        
      GenericUnoccupiedSpace : lod0Point
        
      GenericUnoccupiedSpace : lod1Solid
        
      GenericUnoccupiedSpace : lod1TerrainIntersectionCurve
        
      GenericUnoccupiedSpace : lod2MultiCurve
        
      GenericUnoccupiedSpace : lod2MultiSurface
        
      GenericUnoccupiedSpace : lod2Solid
        
      GenericUnoccupiedSpace : lod2TerrainIntersectionCurve
        
      GenericUnoccupiedSpace : lod3MultiCurve
        
      GenericUnoccupiedSpace : lod3MultiSurface
        
      GenericUnoccupiedSpace : lod3Solid
        
      GenericUnoccupiedSpace : lod3TerrainIntersectionCurve
        
      GenericUnoccupiedSpace : name
        
      GenericUnoccupiedSpace : pointCloud
        
          
    
        
        
        GenericUnoccupiedSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      GenericUnoccupiedSpace : relatedTo
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericUnoccupiedSpace : relativeToTerrain
        
          
    
        
        
        GenericUnoccupiedSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      GenericUnoccupiedSpace : relativeToWater
        
          
    
        
        
        GenericUnoccupiedSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      GenericUnoccupiedSpace : spaceType
        
          
    
        
        
        GenericUnoccupiedSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      GenericUnoccupiedSpace : terminationDate
        
      GenericUnoccupiedSpace : usage
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" GenericUnoccupiedSpaceUsageValue : usage
        click GenericUnoccupiedSpaceUsageValue href "../GenericUnoccupiedSpaceUsageValue/"
    

        
      GenericUnoccupiedSpace : validFrom
        
      GenericUnoccupiedSpace : validTo
        
      GenericUnoccupiedSpace : volume
        
          
    
        
        
        GenericUnoccupiedSpace --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [GenericUnoccupiedSpaceClassValue](GenericUnoccupiedSpaceClassValue.md) | Indicates the specific type of the GenericUnoccupiedSpace | direct |
| [function](function.md) | * <br/> [GenericUnoccupiedSpaceFunctionValue](GenericUnoccupiedSpaceFunctionValue.md) | Specifies the intended purposes of the GenericUnoccupiedSpace | direct |
| [usage](usage.md) | * <br/> [GenericUnoccupiedSpaceUsageValue](GenericUnoccupiedSpaceUsageValue.md) | Specifies the actual uses of the GenericUnoccupiedSpace | direct |
| [adeOfGenericUnoccupiedSpace](adeOfGenericUnoccupiedSpace.md) | * <br/> [ADEOfGenericUnoccupiedSpace](ADEOfGenericUnoccupiedSpace.md) | Augments the GenericUnoccupiedSpace with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:GenericUnoccupiedSpace |
| native | citygml:GenericUnoccupiedSpace |
...
description: A GenericUnoccupiedSpace is a space that is not represented by any explicitly
  modeled AbstractUnoccupiedSpace subclass within CityGML.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the GenericUnoccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: GenericUnoccupiedSpaceClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the GenericUnoccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericUnoccupiedSpaceFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the GenericUnoccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericUnoccupiedSpaceUsageValue
    required: false
    multivalued: true
  adeOfGenericUnoccupiedSpace:
    name: adeOfGenericUnoccupiedSpace
    description: Augments the GenericUnoccupiedSpace with properties defined in an
      ADE.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - GenericUnoccupiedSpace
    range: ADEOfGenericUnoccupiedSpace
    required: false
    multivalued: true
...
attributes:
  ...
  adeOfGenericUnoccupiedSpace:
    ...
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    alias: adeOfGenericUnoccupiedSpace
    owner: GenericUnoccupiedSpace
    domain_of:
    - GenericUnoccupiedSpace
    range: ADEOfGenericUnoccupiedSpace

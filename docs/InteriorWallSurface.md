...
_An InteriorWallSurface is a surface that is visible from inside a construction. An example is the wall of a room._





URI: [citygml:InteriorWallSurface](https://www.ogc.org/standards/citygml/InteriorWallSurface)
...
```mermaid
 classDiagram
    ...
    click InteriorWallSurface href "../InteriorWallSurface/"
      ...
      InteriorWallSurface : adeOfAbstractCityObject
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      InteriorWallSurface : adeOfAbstractConstructionSurface
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractConstructionSurface : adeOfAbstractConstructionSurface
        click ADEOfAbstractConstructionSurface href "../ADEOfAbstractConstructionSurface/"
    

        
      InteriorWallSurface : adeOfAbstractFeature
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      InteriorWallSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      InteriorWallSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      InteriorWallSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      InteriorWallSurface : adeOfInteriorWallSurface
        
          
    
        
        
        InteriorWallSurface --> "*" ADEOfInteriorWallSurface : adeOfInteriorWallSurface
        click ADEOfInteriorWallSurface href "../ADEOfInteriorWallSurface/"
    

        
      InteriorWallSurface : appearance
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      InteriorWallSurface : area
        
          
    
        
        
        InteriorWallSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      InteriorWallSurface : creationDate
        
      InteriorWallSurface : description
        
      InteriorWallSurface : dynamizer
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      InteriorWallSurface : externalReference
        
          
    
        
        
        InteriorWallSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      InteriorWallSurface : featureID
        
          
    
        
        
        InteriorWallSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      InteriorWallSurface : fillingSurface
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractFillingSurface : fillingSurface
        click AbstractFillingSurface href "../AbstractFillingSurface/"
    

        
      InteriorWallSurface : generalizesTo
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      InteriorWallSurface : genericAttribute
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      InteriorWallSurface : identifier
        
      InteriorWallSurface : lod0MultiCurve
        
      InteriorWallSurface : lod0MultiSurface
        
      InteriorWallSurface : lod1MultiSurface
        
      InteriorWallSurface : lod2MultiSurface
        
      InteriorWallSurface : lod3MultiSurface
        
      InteriorWallSurface : name
        
      InteriorWallSurface : pointCloud
        
          
    
        
        
        InteriorWallSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      InteriorWallSurface : relatedTo
        
          
    
        
        
        InteriorWallSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      InteriorWallSurface : relativeToTerrain
        
          
    
        
        
        InteriorWallSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      InteriorWallSurface : relativeToWater
        
          
    
        
        
        InteriorWallSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      InteriorWallSurface : terminationDate
        
      InteriorWallSurface : validFrom
        
      InteriorWallSurface : validTo
...
| ---  | --- | --- | --- |
| [adeOfInteriorWallSurface](adeOfInteriorWallSurface.md) | * <br/> [ADEOfInteriorWallSurface](ADEOfInteriorWallSurface.md) | Augments the InteriorWallSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:InteriorWallSurface |
| native | citygml:InteriorWallSurface |
...
description: An InteriorWallSurface is a surface that is visible from inside a construction.

...
_Relates to a 3D MultiCurve geometry that represents the space in Level of Detail 3._





URI: [citygml:lod3MultiCurve](https://www.ogc.org/standards/citygml/lod3MultiCurve)
...
| Domain Of | [AbstractSpace](AbstractSpace.md) |
...
| Property | Value |
| --- | --- |
| Owner | [AbstractSpace](AbstractSpace.md) |
...
| ---  | ---  |
| self | citygml:lod3MultiCurve |
| native | citygml:lod3MultiCurve |
...
```yaml
name: lod3MultiCurve
description: Relates to a 3D MultiCurve geometry that represents the space in Level
  of Detail 3.

...
# Slot: relativeToWater 


_Describes the vertical position of the city object relative to the surrounding water surface._





URI: [citygml:relativeToWater](https://www.ogc.org/standards/citygml/relativeToWater)
...
| Property | Value |
| --- | --- |
| Range | [RelativeToWater](RelativeToWater.md) |
...
| ---  | ---  |
| self | citygml:relativeToWater |
| native | citygml:relativeToWater |

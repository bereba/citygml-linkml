...
_AbstractFillingElement is the abstract superclass for different kinds of elements that fill the openings of a construction._
...
URI: [citygml:AbstractFillingElement](https://www.ogc.org/standards/citygml/AbstractFillingElement)
...
```mermaid
 classDiagram
    ...
    click AbstractFillingElement href "../AbstractFillingElement/"
      ...
      AbstractFillingElement <|-- Door
        click Door href "../Door/"
      AbstractFillingElement <|-- Window
        click Window href "../Window/"
      

      AbstractFillingElement : adeOfAbstractCityObject
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractFillingElement : adeOfAbstractFeature
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractFillingElement : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractFillingElement : adeOfAbstractFillingElement
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractFillingElement : adeOfAbstractFillingElement
        click ADEOfAbstractFillingElement href "../ADEOfAbstractFillingElement/"
    

        
      AbstractFillingElement : adeOfAbstractOccupiedSpace
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      AbstractFillingElement : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractFillingElement : adeOfAbstractSpace
        
          
    
        
        
        AbstractFillingElement --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractFillingElement : appearance
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractFillingElement : area
        
          
    
        
        
        AbstractFillingElement --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractFillingElement : boundary
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      AbstractFillingElement : creationDate
        
      AbstractFillingElement : description
        
      AbstractFillingElement : dynamizer
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractFillingElement : externalReference
        
          
    
        
        
        AbstractFillingElement --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractFillingElement : featureID
        
          
    
        
        
        AbstractFillingElement --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractFillingElement : generalizesTo
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractFillingElement : genericAttribute
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractFillingElement : identifier
        
      AbstractFillingElement : lod0MultiCurve
        
      AbstractFillingElement : lod0MultiSurface
        
      AbstractFillingElement : lod0Point
        
      AbstractFillingElement : lod1ImplicitRepresentation
        
          
    
        
        
        AbstractFillingElement --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractFillingElement : lod1Solid
        
      AbstractFillingElement : lod1TerrainIntersectionCurve
        
      AbstractFillingElement : lod2ImplicitRepresentation
        
          
    
        
        
        AbstractFillingElement --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractFillingElement : lod2MultiCurve
        
      AbstractFillingElement : lod2MultiSurface
        
      AbstractFillingElement : lod2Solid
        
      AbstractFillingElement : lod2TerrainIntersectionCurve
        
      AbstractFillingElement : lod3ImplicitRepresentation
        
          
    
        
        
        AbstractFillingElement --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractFillingElement : lod3MultiCurve
        
      AbstractFillingElement : lod3MultiSurface
        
      AbstractFillingElement : lod3Solid
        
      AbstractFillingElement : lod3TerrainIntersectionCurve
        
      AbstractFillingElement : name
        
      AbstractFillingElement : pointCloud
        
          
    
        
        
        AbstractFillingElement --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractFillingElement : relatedTo
        
          
    
        
        
        AbstractFillingElement --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractFillingElement : relativeToTerrain
        
          
    
        
        
        AbstractFillingElement --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractFillingElement : relativeToWater
        
          
    
        
        
        AbstractFillingElement --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractFillingElement : spaceType
        
          
    
        
        
        AbstractFillingElement --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractFillingElement : terminationDate
        
      AbstractFillingElement : validFrom
        
      AbstractFillingElement : validTo
        
      AbstractFillingElement : volume
        
          
    
        
        
        AbstractFillingElement --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [adeOfAbstractFillingElement](adeOfAbstractFillingElement.md) | * <br/> [ADEOfAbstractFillingElement](ADEOfAbstractFillingElement.md) | Augments AbstractFillingElement with properties defined in an ADE | direct |
...
| ---  | --- | --- | --- |
| [AbstractConstructiveElement](AbstractConstructiveElement.md) | [filling](filling.md) | range | [AbstractFillingElement](AbstractFillingElement.md) |
| [BridgeConstructiveElement](BridgeConstructiveElement.md) | [filling](filling.md) | range | [AbstractFillingElement](AbstractFillingElement.md) |
| [BuildingConstructiveElement](BuildingConstructiveElement.md) | [filling](filling.md) | range | [AbstractFillingElement](AbstractFillingElement.md) |
| [TunnelConstructiveElement](TunnelConstructiveElement.md) | [filling](filling.md) | range | [AbstractFillingElement](AbstractFillingElement.md) |
...
| ---  | ---  |
| self | citygml:AbstractFillingElement |
| native | citygml:AbstractFillingElement |
...
<details>
```yaml
name: AbstractFillingElement
description: AbstractFillingElement is the abstract superclass for different kinds
  of elements that fill the openings of a construction.

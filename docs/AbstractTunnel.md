...
_AbstractTunnel is an abstract superclass representing the common attributes and associations of the classes Tunnel and TunnelPart._
...
URI: [citygml:AbstractTunnel](https://www.ogc.org/standards/citygml/AbstractTunnel)
...
```mermaid
 classDiagram
    ...
    click AbstractTunnel href "../AbstractTunnel/"
      ...
      AbstractTunnel : adeOfAbstractCityObject
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractTunnel : adeOfAbstractConstruction
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractConstruction : adeOfAbstractConstruction
        click ADEOfAbstractConstruction href "../ADEOfAbstractConstruction/"
    

        
      AbstractTunnel : adeOfAbstractFeature
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractTunnel : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractTunnel : adeOfAbstractOccupiedSpace
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      AbstractTunnel : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractTunnel : adeOfAbstractSpace
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractTunnel : adeOfAbstractTunnel
        
          
    
        
        
        AbstractTunnel --> "*" ADEOfAbstractTunnel : adeOfAbstractTunnel
        click ADEOfAbstractTunnel href "../ADEOfAbstractTunnel/"
    

        
      AbstractTunnel : appearance
        
          
    
        
        
        AbstractTunnel --> "*" AbstractAppearance : appearance
      ...
      AbstractTunnel : area
        ...
        AbstractTunnel --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractTunnel : boundary
        
          
    
        
        
        AbstractTunnel --> "*" AbstractThematicSurface : boundary
        click AbstractThematicSurface href "../AbstractThematicSurface/"
    

        
      AbstractTunnel : class
        
          
    
        
        
        AbstractTunnel --> "0..1" TunnelClassValue : class
        click TunnelClassValue href "../TunnelClassValue/"
    

        
      AbstractTunnel : conditionOfConstruction
        
          
    
        
        
        AbstractTunnel --> "0..1" ConditionOfConstructionValue : conditionOfConstruction
        click ConditionOfConstructionValue href "../ConditionOfConstructionValue/"
    

        
      AbstractTunnel : constructionEvent
        
          
    
        
        
        AbstractTunnel --> "*" ConstructionEvent : constructionEvent
        click ConstructionEvent href "../ConstructionEvent/"
    

        
      AbstractTunnel : creationDate
        
      AbstractTunnel : dateOfConstruction
        
      AbstractTunnel : dateOfDemolition
        
      AbstractTunnel : description
        
      AbstractTunnel : dynamizer
        
          
    
        
        
        AbstractTunnel --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractTunnel : elevation
        
          
    
        
        
        AbstractTunnel --> "*" Elevation : elevation
        click Elevation href "../Elevation/"
    

        
      AbstractTunnel : externalReference
        
          
    
        
        
        AbstractTunnel --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractTunnel : featureID
        
          
    
        
        
        AbstractTunnel --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractTunnel : function
        
          
    
        
        
        AbstractTunnel --> "*" TunnelFunctionValue : function
        click TunnelFunctionValue href "../TunnelFunctionValue/"
    

        
      AbstractTunnel : generalizesTo
        
          
    
        
        
        AbstractTunnel --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractTunnel : genericAttribute
        
          
    
        
        
        AbstractTunnel --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractTunnel : height
        
          
    
        
        
        AbstractTunnel --> "*" Height : height
        click Height href "../Height/"
    

        
      AbstractTunnel : hollowSpace
        
          
    
        
        
        AbstractTunnel --> "*" HollowSpace : hollowSpace
        click HollowSpace href "../HollowSpace/"
    

        
      AbstractTunnel : identifier
        
      AbstractTunnel : lod0MultiCurve
        
      AbstractTunnel : lod0MultiSurface
        
      AbstractTunnel : lod0Point
        
      AbstractTunnel : lod1ImplicitRepresentation
        
          
    
        
        
        AbstractTunnel --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractTunnel : lod1Solid
        
      AbstractTunnel : lod1TerrainIntersectionCurve
        
      AbstractTunnel : lod2ImplicitRepresentation
        
          
    
        
        
        AbstractTunnel --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractTunnel : lod2MultiCurve
        
      AbstractTunnel : lod2MultiSurface
        
      AbstractTunnel : lod2Solid
        
      AbstractTunnel : lod2TerrainIntersectionCurve
        
      AbstractTunnel : lod3ImplicitRepresentation
        
          
    
        
        
        AbstractTunnel --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractTunnel : lod3MultiCurve
        
      AbstractTunnel : lod3MultiSurface
        
      AbstractTunnel : lod3Solid
        
      AbstractTunnel : lod3TerrainIntersectionCurve
        
      AbstractTunnel : name
        
      AbstractTunnel : occupancy
        
          
    
        
        
        AbstractTunnel --> "*" Occupancy : occupancy
        click Occupancy href "../Occupancy/"
    

        
      AbstractTunnel : pointCloud
        
          
    
        
        
        AbstractTunnel --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractTunnel : relatedTo
        
          
    
        
        
        AbstractTunnel --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractTunnel : relativeToTerrain
        
          
    
        
        
        AbstractTunnel --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractTunnel : relativeToWater
        
          
    
        
        
        AbstractTunnel --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractTunnel : spaceType
        
          
    
        
        
        AbstractTunnel --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractTunnel : terminationDate
        
      AbstractTunnel : tunnelConstructiveElement
        
          
    
        
        
        AbstractTunnel --> "*" TunnelConstructiveElement : tunnelConstructiveElement
        click TunnelConstructiveElement href "../TunnelConstructiveElement/"
    

        
      AbstractTunnel : tunnelFurniture
        
          
    
        
        
        AbstractTunnel --> "*" TunnelFurniture : tunnelFurniture
        click TunnelFurniture href "../TunnelFurniture/"
    

        
      AbstractTunnel : tunnelInstallation
        
          
    
        
        
        AbstractTunnel --> "*" TunnelInstallation : tunnelInstallation
        click TunnelInstallation href "../TunnelInstallation/"
    

        
      AbstractTunnel : usage
        
          
    
        
        
        AbstractTunnel --> "*" TunnelUsageValue : usage
        click TunnelUsageValue href "../TunnelUsageValue/"
    

        
      AbstractTunnel : validFrom
        
      AbstractTunnel : validTo
        
      AbstractTunnel : volume
        
          
    
        
        
        AbstractTunnel --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [TunnelClassValue](TunnelClassValue.md) | Indicates the specific type of the Tunnel or TunnelPart | direct |
| [function](function.md) | * <br/> [TunnelFunctionValue](TunnelFunctionValue.md) | Specifies the intended purposes of the Tunnel or TunnelPart | direct |
| [usage](usage.md) | * <br/> [TunnelUsageValue](TunnelUsageValue.md) | Specifies the actual uses of the Tunnel or TunnelPart | direct |
| [adeOfAbstractTunnel](adeOfAbstractTunnel.md) | * <br/> [ADEOfAbstractTunnel](ADEOfAbstractTunnel.md) | Augments AbstractTunnel with properties defined in an ADE | direct |
| [tunnelConstructiveElement](tunnelConstructiveElement.md) | * <br/> [TunnelConstructiveElement](TunnelConstructiveElement.md) | Relates the constructive elements to the Tunnel or TunnelPart | direct |
| [tunnelFurniture](tunnelFurniture.md) | * <br/> [TunnelFurniture](TunnelFurniture.md) | Relates the furniture objects to the Tunnel or TunnelPart | direct |
| [tunnelInstallation](tunnelInstallation.md) | * <br/> [TunnelInstallation](TunnelInstallation.md) | Relates the installation objects to the Tunnel or TunnelPart | direct |
| [hollowSpace](hollowSpace.md) | * <br/> [HollowSpace](HollowSpace.md) | Relates the hollow spaces to the Tunnel or TunnelPart | direct |
...
| ---  | ---  |
| self | citygml:AbstractTunnel |
| native | citygml:AbstractTunnel |
...
```yaml
name: AbstractTunnel
description: AbstractTunnel is an abstract superclass representing the common attributes
  and associations of the classes Tunnel and TunnelPart.

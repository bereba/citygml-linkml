...
_Indicates the date at which a CityGML feature ended to exist in the real world._





URI: [citygml:validTo](https://www.ogc.org/standards/citygml/validTo)
Alias: validTo
...
| ---  | ---  |
| self | citygml:validTo |
| native | citygml:validTo |
...
```yaml
name: validTo
description: Indicates the date at which a CityGML feature ended to exist in the real
  world.

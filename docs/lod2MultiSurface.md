...
# Slot: lod2MultiSurface 



URI: [citygml:lod2MultiSurface](https://www.ogc.org/standards/citygml/lod2MultiSurface)
...
| Domain Of | [AbstractSpace](AbstractSpace.md), [AbstractThematicSurface](AbstractThematicSurface.md) |
...
| ---  | ---  |
| self | citygml:lod2MultiSurface |
| native | citygml:lod2MultiSurface |

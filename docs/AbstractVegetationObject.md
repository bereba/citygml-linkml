...
_AbstractVegetationObject is the abstract superclass for all kinds of vegetation objects._
...
URI: [citygml:AbstractVegetationObject](https://www.ogc.org/standards/citygml/AbstractVegetationObject)
...
```mermaid
 classDiagram
    ...
    click AbstractVegetationObject href "../AbstractVegetationObject/"
      ...
      AbstractVegetationObject : adeOfAbstractCityObject
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractVegetationObject : adeOfAbstractFeature
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractVegetationObject : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractVegetationObject : adeOfAbstractOccupiedSpace
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      AbstractVegetationObject : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractVegetationObject : adeOfAbstractSpace
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractVegetationObject : adeOfAbstractVegetationObject
        
          
    
        
        
        AbstractVegetationObject --> "*" ADEOfAbstractVegetationObject : adeOfAbstractVegetationObject
        click ADEOfAbstractVegetationObject href "../ADEOfAbstractVegetationObject/"
    

        
      AbstractVegetationObject : appearance
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractVegetationObject : area
        
          
    
        
        
        AbstractVegetationObject --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractVegetationObject : boundary
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      AbstractVegetationObject : creationDate
        
      AbstractVegetationObject : description
        
      AbstractVegetationObject : dynamizer
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractVegetationObject : externalReference
        
          
    
        
        
        AbstractVegetationObject --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractVegetationObject : featureID
        
          
    
        
        
        AbstractVegetationObject --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractVegetationObject : generalizesTo
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractVegetationObject : genericAttribute
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractVegetationObject : identifier
        
      AbstractVegetationObject : lod0MultiCurve
        
      AbstractVegetationObject : lod0MultiSurface
        
      AbstractVegetationObject : lod0Point
        
      AbstractVegetationObject : lod1ImplicitRepresentation
        
          
    
        
        
        AbstractVegetationObject --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractVegetationObject : lod1Solid
        
      AbstractVegetationObject : lod1TerrainIntersectionCurve
        
      AbstractVegetationObject : lod2ImplicitRepresentation
        
          
    
        
        
        AbstractVegetationObject --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractVegetationObject : lod2MultiCurve
        
      AbstractVegetationObject : lod2MultiSurface
        
      AbstractVegetationObject : lod2Solid
        
      AbstractVegetationObject : lod2TerrainIntersectionCurve
        
      AbstractVegetationObject : lod3ImplicitRepresentation
        
          
    
        
        
        AbstractVegetationObject --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractVegetationObject : lod3MultiCurve
        
      AbstractVegetationObject : lod3MultiSurface
        
      AbstractVegetationObject : lod3Solid
        
      AbstractVegetationObject : lod3TerrainIntersectionCurve
        
      AbstractVegetationObject : name
        
      AbstractVegetationObject : pointCloud
        
          
    
        
        
        AbstractVegetationObject --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractVegetationObject : relatedTo
        
          
    
        
        
        AbstractVegetationObject --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractVegetationObject : relativeToTerrain
        
          
    
        
        
        AbstractVegetationObject --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractVegetationObject : relativeToWater
        
          
    
        
        
        AbstractVegetationObject --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractVegetationObject : spaceType
        
          
    
        
        
        AbstractVegetationObject --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractVegetationObject : terminationDate
        
      AbstractVegetationObject : validFrom
        
      AbstractVegetationObject : validTo
        
      AbstractVegetationObject : volume
        
          
    
        
        
        AbstractVegetationObject --> "*" QualifiedVolume : volume
                ...
                * [AbstractPhysicalSpace](AbstractPhysicalSpace.md)
                    * [AbstractOccupiedSpace](AbstractOccupiedSpace.md)
                        * **AbstractVegetationObject**
                            * [PlantCover](PlantCover.md)
                            * [SolitaryVegetationObject](SolitaryVegetationObject.md)
...
| ---  | --- | --- | --- |
| [adeOfAbstractVegetationObject](adeOfAbstractVegetationObject.md) | * <br/> [ADEOfAbstractVegetationObject](ADEOfAbstractVegetationObject.md) | Augments AbstractVegetationObject with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:AbstractVegetationObject |
| native | citygml:AbstractVegetationObject |
...
<details>
```yaml
name: AbstractVegetationObject
description: AbstractVegetationObject is the abstract superclass for all kinds of
  vegetation objects.

...
_AbstractConstructiveElement is the abstract superclass for the representation of volumetric elements of a construction. Examples are walls, beams, slabs._
...
URI: [citygml:AbstractConstructiveElement](https://www.ogc.org/standards/citygml/AbstractConstructiveElement)
...
```mermaid
 classDiagram
    ...
    click AbstractConstructiveElement href "../AbstractConstructiveElement/"
      AbstractOccupiedSpace <|-- AbstractConstructiveElement
      ...
      AbstractConstructiveElement : adeOfAbstractCityObject
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractConstructiveElement : adeOfAbstractConstructiveElement
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractConstructiveElement : adeOfAbstractConstructiveElement
        click ADEOfAbstractConstructiveElement href "../ADEOfAbstractConstructiveElement/"
    

        
      AbstractConstructiveElement : adeOfAbstractFeature
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractConstructiveElement : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractConstructiveElement : adeOfAbstractOccupiedSpace
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      AbstractConstructiveElement : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractConstructiveElement : adeOfAbstractSpace
        
          
    
        
        
        AbstractConstructiveElement --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractConstructiveElement : appearance
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractConstructiveElement : area
        
          
    
        
        
        AbstractConstructiveElement --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractConstructiveElement : boundary
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractThematicSurface : boundary
        click AbstractThematicSurface href "../AbstractThematicSurface/"
    

        
      AbstractConstructiveElement : creationDate
        
      AbstractConstructiveElement : description
        
      AbstractConstructiveElement : dynamizer
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractConstructiveElement : externalReference
        
          
    
        
        
        AbstractConstructiveElement --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractConstructiveElement : featureID
        
          
    
        
        
        AbstractConstructiveElement --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractConstructiveElement : filling
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractFillingElement : filling
        click AbstractFillingElement href "../AbstractFillingElement/"
    

        
      AbstractConstructiveElement : generalizesTo
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractConstructiveElement : genericAttribute
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractConstructiveElement : identifier
        
      AbstractConstructiveElement : isStructuralElement
        
      AbstractConstructiveElement : lod0MultiCurve
        
      AbstractConstructiveElement : lod0MultiSurface
        
      AbstractConstructiveElement : lod0Point
        
      AbstractConstructiveElement : lod1ImplicitRepresentation
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractConstructiveElement : lod1Solid
        
      AbstractConstructiveElement : lod1TerrainIntersectionCurve
        
      AbstractConstructiveElement : lod2ImplicitRepresentation
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractConstructiveElement : lod2MultiCurve
        
      AbstractConstructiveElement : lod2MultiSurface
        
      AbstractConstructiveElement : lod2Solid
        
      AbstractConstructiveElement : lod2TerrainIntersectionCurve
        
      AbstractConstructiveElement : lod3ImplicitRepresentation
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractConstructiveElement : lod3MultiCurve
        
      AbstractConstructiveElement : lod3MultiSurface
        
      AbstractConstructiveElement : lod3Solid
        
      AbstractConstructiveElement : lod3TerrainIntersectionCurve
        
      AbstractConstructiveElement : name
        
      AbstractConstructiveElement : pointCloud
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractConstructiveElement : relatedTo
        
          
    
        
        
        AbstractConstructiveElement --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractConstructiveElement : relativeToTerrain
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractConstructiveElement : relativeToWater
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractConstructiveElement : spaceType
        
          
    
        
        
        AbstractConstructiveElement --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractConstructiveElement : terminationDate
        
      AbstractConstructiveElement : validFrom
        
      AbstractConstructiveElement : validTo
        
      AbstractConstructiveElement : volume
        
          
    
        
        
        AbstractConstructiveElement --> "*" QualifiedVolume : volume
                ...
                * [AbstractPhysicalSpace](AbstractPhysicalSpace.md)
                    * [AbstractOccupiedSpace](AbstractOccupiedSpace.md)
                        * **AbstractConstructiveElement**
                            * [BridgeConstructiveElement](BridgeConstructiveElement.md)
                            * [BuildingConstructiveElement](BuildingConstructiveElement.md)
                            * [TunnelConstructiveElement](TunnelConstructiveElement.md)
...
| ---  | --- | --- | --- |
| [isStructuralElement](isStructuralElement.md) | 0..1 <br/> [Boolean](Boolean.md) | Indicates whether the constructive element is essential from a structural poi... | direct |
| [adeOfAbstractConstructiveElement](adeOfAbstractConstructiveElement.md) | * <br/> [ADEOfAbstractConstructiveElement](ADEOfAbstractConstructiveElement.md) | Augments AbstractConstructiveElement with properties defined in an ADE | direct |
| [filling](filling.md) | * <br/> [AbstractFillingElement](AbstractFillingElement.md) | Relates to the elements that fill the opening of the constructive element | direct |
...
| ---  | ---  |
| self | citygml:AbstractConstructiveElement |
| native | citygml:AbstractConstructiveElement |
...
<details>
```yaml
name: AbstractConstructiveElement
description: AbstractConstructiveElement is the abstract superclass for the representation
  of volumetric elements of a construction. Examples are walls, beams, slabs.

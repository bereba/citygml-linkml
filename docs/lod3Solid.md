...
_Relates to a 3D Solid geometry that represents the space in Level of Detail 3._





URI: [citygml:lod3Solid](https://www.ogc.org/standards/citygml/lod3Solid)
Alias: lod3Solid
...
| ---  | ---  |
| self | citygml:lod3Solid |
| native | citygml:lod3Solid |

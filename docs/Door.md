...
_A Door is a construction for closing an opening intended primarily for access or egress or both. [cf. ISO 6707-1]_





URI: [citygml:Door](https://www.ogc.org/standards/citygml/Door)
...
```mermaid
 classDiagram
    ...
    click Door href "../Door/"
      ...
      Door : adeOfAbstractCityObject
        
          
    
        
        
        Door --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      Door : adeOfAbstractFeature
        
          
    
        
        
        Door --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      Door : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        Door --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      Door : adeOfAbstractFillingElement
        
          
    
        
        
        Door --> "*" ADEOfAbstractFillingElement : adeOfAbstractFillingElement
        click ADEOfAbstractFillingElement href "../ADEOfAbstractFillingElement/"
    

        
      Door : adeOfAbstractOccupiedSpace
        
          
    
        
        
        Door --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      Door : adeOfAbstractPhysicalSpace
        
          
    
        
        
        Door --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      Door : adeOfAbstractSpace
        
          
    
        
        
        Door --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
      ...
      Door : adeOfDoor
        ...
        Door --> "*" ADEOfDoor : adeOfDoor
        click ADEOfDoor href "../ADEOfDoor/"
      ...
      Door : appearance
        ...
        Door --> "*" AbstractAppearance : appearance
      ...
      Door : class
        ...
        Door --> "0..1" DoorClassValue : class
        click DoorClassValue href "../DoorClassValue/"
      ...
      Door : dynamizer
        ...
        Door --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      Door : externalReference
        
          
    
        
        
        Door --> "*" ExternalReference : externalReference
      ...
      Door : function
        ...
        Door --> "*" DoorFunctionValue : function
        click DoorFunctionValue href "../DoorFunctionValue/"
      ...
      Door : generalizesTo
        ...
        Door --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Door : genericAttribute
        
          
    
        
        
        Door --> "*" AbstractGenericAttribute : genericAttribute
      ...
      Door : lod0MultiSurface
        
      Door : lod0Point
        
      Door : lod1ImplicitRepresentation
        
          
    
        
        
        Door --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
      ...
      Door : lod1TerrainIntersectionCurve
        
      Door : lod2ImplicitRepresentation
        
          
    
        
        
        Door --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
      ...
      Door : lod2MultiSurface
        
      Door : lod2Solid
        
      Door : lod2TerrainIntersectionCurve
        
      Door : lod3ImplicitRepresentation
        
          
    
        
        
        Door --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
      ...
      Door : lod3MultiSurface
        
      Door : lod3Solid
        
      Door : lod3TerrainIntersectionCurve
      ...
      Door : pointCloud
        ...
        Door --> "0..1" AbstractPointCloud : pointCloud
      ...
      Door : relatedTo
        ...
        Door --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Door : relativeToTerrain
        
          
    
        
        
        Door --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      Door : relativeToWater
        
          
    
        
        
        Door --> "0..1" RelativeToWater : relativeToWater
      ...
      Door : spaceType
        ...
        Door --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      Door : terminationDate
      ...
      Door : usage
        ...
        Door --> "*" DoorUsageValue : usage
        click DoorUsageValue href "../DoorUsageValue/"
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [DoorClassValue](DoorClassValue.md) | Indicates the specific type of the Door | direct |
| [function](function.md) | * <br/> [DoorFunctionValue](DoorFunctionValue.md) | Specifies the intended purposes of the Door | direct |
| [usage](usage.md) | * <br/> [DoorUsageValue](DoorUsageValue.md) | Specifies the actual uses of the Door | direct |
| [adeOfDoor](adeOfDoor.md) | * <br/> [ADEOfDoor](ADEOfDoor.md) | Augments the Door with properties defined in an ADE | direct |
| [boundary](boundary.md) | * <br/> [DoorSurface](DoorSurface.md) |  | direct |
| [address](address.md) | * <br/> [Address](Address.md) | Relates to the addresses that are assigned to the Door | direct |
...
```yaml
name: Door
description: A Door is a construction for closing an opening intended primarily for
  access or egress or both. [cf. ISO 6707-1]
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the Door.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - Door
    ...
    - WaterBody
    range: DoorClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the Door.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - Door
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: DoorFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the Door.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - Door
  ...
  address:
    name: address
    description: Relates to the addresses that are assigned to the Door.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - Door

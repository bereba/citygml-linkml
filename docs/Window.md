...
_A Window is a construction for closing an opening in a wall  or roof, primarily intended to admit light and/or provide ventilation. [cf. ISO  6707-1]_





URI: [citygml:Window](https://www.ogc.org/standards/citygml/Window)
...
```mermaid
 classDiagram
    ...
    click Window href "../Window/"
      ...
      Window : adeOfAbstractCityObject
        
          
    
        
        
        Window --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      Window : adeOfAbstractFeature
        
          
    
        
        
        Window --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      Window : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        Window --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      Window : adeOfAbstractFillingElement
        
          
    
        
        
        Window --> "*" ADEOfAbstractFillingElement : adeOfAbstractFillingElement
        click ADEOfAbstractFillingElement href "../ADEOfAbstractFillingElement/"
    

        
      Window : adeOfAbstractOccupiedSpace
        
          
    
        
        
        Window --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      Window : adeOfAbstractPhysicalSpace
        
          
    
        
        
        Window --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      Window : adeOfAbstractSpace
        
          
    
        
        
        Window --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
      ...
      Window : adeOfWindow
        ...
        Window --> "*" ADEOfWindow : adeOfWindow
        click ADEOfWindow href "../ADEOfWindow/"
      ...
      Window : appearance
        ...
        Window --> "*" AbstractAppearance : appearance
      ...
      Window : class
        ...
        Window --> "0..1" WindowClassValue : class
        click WindowClassValue href "../WindowClassValue/"
      ...
      Window : dynamizer
        ...
        Window --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      Window : externalReference
        
          
    
        
        
        Window --> "*" ExternalReference : externalReference
      ...
      Window : function
        ...
        Window --> "*" WindowFunctionValue : function
        click WindowFunctionValue href "../WindowFunctionValue/"
    

        
      Window : generalizesTo
        
          
    
        
        
        Window --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Window : genericAttribute
        
          
    
        
        
        Window --> "*" AbstractGenericAttribute : genericAttribute
      ...
      Window : lod0MultiCurve
        
      Window : lod0MultiSurface
        
      Window : lod0Point
        
      Window : lod1ImplicitRepresentation
        
          
    
        
        
        Window --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
      ...
      Window : lod1TerrainIntersectionCurve
        
      Window : lod2ImplicitRepresentation
        
          
    
        
        
        Window --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      Window : lod2MultiCurve
        
      Window : lod2MultiSurface
        
      Window : lod2Solid
        
      Window : lod2TerrainIntersectionCurve
        
      Window : lod3ImplicitRepresentation
        
          
    
        
        
        Window --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      Window : lod3MultiCurve
        
      Window : lod3MultiSurface
        
      Window : lod3Solid
        
      Window : lod3TerrainIntersectionCurve
      ...
      Window : pointCloud
        ...
        Window --> "0..1" AbstractPointCloud : pointCloud
      ...
      Window : relatedTo
        ...
        Window --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Window : relativeToTerrain
        
          
    
        
        
        Window --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      Window : relativeToWater
        
          
    
        
        
        Window --> "0..1" RelativeToWater : relativeToWater
      ...
      Window : spaceType
        ...
        Window --> "0..1" SpaceType : spaceType
      ...
      Window : usage
        ...
        Window --> "*" WindowUsageValue : usage
        click WindowUsageValue href "../WindowUsageValue/"
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [WindowClassValue](WindowClassValue.md) | Indicates the specific type of the Window | direct |
| [function](function.md) | * <br/> [WindowFunctionValue](WindowFunctionValue.md) | Specifies the intended purposes of the Window | direct |
| [usage](usage.md) | * <br/> [WindowUsageValue](WindowUsageValue.md) | Specifies the actual uses of the Window | direct |
| [adeOfWindow](adeOfWindow.md) | * <br/> [ADEOfWindow](ADEOfWindow.md) | Augments the Window with properties defined in an ADE | direct |
| [boundary](boundary.md) | * <br/> [WindowSurface](WindowSurface.md) |  | direct |
| [adeOfAbstractFillingElement](adeOfAbstractFillingElement.md) | * <br/> [ADEOfAbstractFillingElement](ADEOfAbstractFillingElement.md) | Augments AbstractFillingElement with properties defined in an ADE | [AbstractFillingElement](AbstractFillingElement.md) |
...
```yaml
name: Window
description: A Window is a construction for closing an opening in a wall  or roof,
  primarily intended to admit light and/or provide ventilation. [cf. ISO  6707-1]
from_schema: https://www.ogc.org/standards/citygml
is_a: AbstractFillingElement
abstract: false
attributes:
  class:
    name: class
    description: Indicates the specific type of the Window.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: WindowClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the Window.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: WindowFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the Window.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction

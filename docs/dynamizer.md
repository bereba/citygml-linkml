...
_Relates Dynamizer objects to the city object. These allow timeseries data to override static attribute values of the city object._
...
| Property | Value |
| --- | --- |
| Range | [AbstractDynamizer](AbstractDynamizer.md) |

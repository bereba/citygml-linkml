...
_Relates to a 3D Solid geometry that represents the space in Level of Detail 2._





URI: [citygml:lod2Solid](https://www.ogc.org/standards/citygml/lod2Solid)
Alias: lod2Solid
...
| ---  | ---  |
| self | citygml:lod2Solid |
| native | citygml:lod2Solid |

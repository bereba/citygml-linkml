...
_A GenericOccupiedSpace is a space that is not represented by any explicitly modeled AbstractOccupiedSpace subclass within CityGML._





URI: [citygml:GenericOccupiedSpace](https://www.ogc.org/standards/citygml/GenericOccupiedSpace)
...
```mermaid
 classDiagram
    class GenericOccupiedSpace
    click GenericOccupiedSpace href "../GenericOccupiedSpace/"
      AbstractOccupiedSpace <|-- GenericOccupiedSpace
        click AbstractOccupiedSpace href "../AbstractOccupiedSpace/"
      
      GenericOccupiedSpace : adeOfAbstractCityObject
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      GenericOccupiedSpace : adeOfAbstractFeature
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      GenericOccupiedSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      GenericOccupiedSpace : adeOfAbstractOccupiedSpace
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      GenericOccupiedSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      GenericOccupiedSpace : adeOfAbstractSpace
        
          
    
        
        
        GenericOccupiedSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
      ...
      GenericOccupiedSpace : adeOfGenericOccupiedSpace
        ...
        GenericOccupiedSpace --> "*" ADEOfGenericOccupiedSpace : adeOfGenericOccupiedSpace
        click ADEOfGenericOccupiedSpace href "../ADEOfGenericOccupiedSpace/"
    

        
      GenericOccupiedSpace : appearance
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      GenericOccupiedSpace : area
        
          
    
        
        
        GenericOccupiedSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      GenericOccupiedSpace : boundary
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      GenericOccupiedSpace : class
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" GenericOccupiedSpaceClassValue : class
        click GenericOccupiedSpaceClassValue href "../GenericOccupiedSpaceClassValue/"
    

        
      GenericOccupiedSpace : creationDate
        
      GenericOccupiedSpace : description
        
      GenericOccupiedSpace : dynamizer
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      GenericOccupiedSpace : externalReference
        
          
    
        
        
        GenericOccupiedSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      GenericOccupiedSpace : featureID
        
          
    
        
        
        GenericOccupiedSpace --> "1" ID : featureID
        click ID href "../ID/"
      ...
      GenericOccupiedSpace : function
        ...
        GenericOccupiedSpace --> "*" GenericOccupiedSpaceFunctionValue : function
        click GenericOccupiedSpaceFunctionValue href "../GenericOccupiedSpaceFunctionValue/"
    

        
      GenericOccupiedSpace : generalizesTo
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericOccupiedSpace : genericAttribute
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      GenericOccupiedSpace : identifier
        
      GenericOccupiedSpace : lod0MultiCurve
        
      GenericOccupiedSpace : lod0MultiSurface
        
      GenericOccupiedSpace : lod0Point
        
      GenericOccupiedSpace : lod1ImplicitRepresentation
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      GenericOccupiedSpace : lod1Solid
        
      GenericOccupiedSpace : lod1TerrainIntersectionCurve
        
      GenericOccupiedSpace : lod2ImplicitRepresentation
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      GenericOccupiedSpace : lod2MultiCurve
        
      GenericOccupiedSpace : lod2MultiSurface
        
      GenericOccupiedSpace : lod2Solid
        
      GenericOccupiedSpace : lod2TerrainIntersectionCurve
        
      GenericOccupiedSpace : lod3ImplicitRepresentation
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      GenericOccupiedSpace : lod3MultiCurve
        
      GenericOccupiedSpace : lod3MultiSurface
        
      GenericOccupiedSpace : lod3Solid
        
      GenericOccupiedSpace : lod3TerrainIntersectionCurve
        
      GenericOccupiedSpace : name
        
      GenericOccupiedSpace : pointCloud
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      GenericOccupiedSpace : relatedTo
        
          
    
        
        
        GenericOccupiedSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      GenericOccupiedSpace : relativeToTerrain
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      GenericOccupiedSpace : relativeToWater
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      GenericOccupiedSpace : spaceType
        
          
    
        
        
        GenericOccupiedSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      GenericOccupiedSpace : terminationDate
        
      GenericOccupiedSpace : usage
        
          
    
        
        
        GenericOccupiedSpace --> "*" GenericOccupiedSpaceUsageValue : usage
        click GenericOccupiedSpaceUsageValue href "../GenericOccupiedSpaceUsageValue/"
    

        
      GenericOccupiedSpace : validFrom
        
      GenericOccupiedSpace : validTo
        
      GenericOccupiedSpace : volume
        
          
    
        
        
        GenericOccupiedSpace --> "*" QualifiedVolume : volume
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [GenericOccupiedSpaceClassValue](GenericOccupiedSpaceClassValue.md) | Indicates the specific type of the GenericOccupiedSpace | direct |
| [function](function.md) | * <br/> [GenericOccupiedSpaceFunctionValue](GenericOccupiedSpaceFunctionValue.md) | Specifies the intended purposes of the GenericOccupiedSpace | direct |
| [usage](usage.md) | * <br/> [GenericOccupiedSpaceUsageValue](GenericOccupiedSpaceUsageValue.md) | Specifies the actual uses of the GenericOccupiedSpace | direct |
| [adeOfGenericOccupiedSpace](adeOfGenericOccupiedSpace.md) | * <br/> [ADEOfGenericOccupiedSpace](ADEOfGenericOccupiedSpace.md) | Augments the GenericOccupiedSpace with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:GenericOccupiedSpace |
| native | citygml:GenericOccupiedSpace |
...
description: A GenericOccupiedSpace is a space that is not represented by any explicitly
  modeled AbstractOccupiedSpace subclass within CityGML.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the GenericOccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - WaterBody
    range: GenericOccupiedSpaceClassValue
    required: false
    multivalued: false
  function:
    name: function
    description: Specifies the intended purposes of the GenericOccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericOccupiedSpaceFunctionValue
    required: false
    multivalued: true
  usage:
    name: usage
    description: Specifies the actual uses of the GenericOccupiedSpace.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction
    ...
    - SolitaryVegetationObject
    - WaterBody
    range: GenericOccupiedSpaceUsageValue
    required: false
    multivalued: true
  adeOfGenericOccupiedSpace:
    name: adeOfGenericOccupiedSpace
    description: Augments the GenericOccupiedSpace with properties defined in an ADE.
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    domain_of:
    - GenericOccupiedSpace
    range: ADEOfGenericOccupiedSpace
    required: false
    multivalued: true
...
attributes:
  ...
  adeOfGenericOccupiedSpace:
    ...
    from_schema: https://www.ogc.org/standards/citygml
    rank: 1000
    alias: adeOfGenericOccupiedSpace
    owner: GenericOccupiedSpace
    domain_of:
    - GenericOccupiedSpace
    range: ADEOfGenericOccupiedSpace

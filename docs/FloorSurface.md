...
_A FloorSurface is surface that represents the interior floor of a construction. An example is the floor of a room._





URI: [citygml:FloorSurface](https://www.ogc.org/standards/citygml/FloorSurface)
...
```mermaid
 classDiagram
    ...
    click FloorSurface href "../FloorSurface/"
      ...
      FloorSurface : adeOfAbstractCityObject
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      FloorSurface : adeOfAbstractConstructionSurface
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractConstructionSurface : adeOfAbstractConstructionSurface
        click ADEOfAbstractConstructionSurface href "../ADEOfAbstractConstructionSurface/"
    

        
      FloorSurface : adeOfAbstractFeature
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      FloorSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      FloorSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      FloorSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        FloorSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      FloorSurface : adeOfFloorSurface
        
          
    
        
        
        FloorSurface --> "*" ADEOfFloorSurface : adeOfFloorSurface
        click ADEOfFloorSurface href "../ADEOfFloorSurface/"
    

        
      FloorSurface : appearance
        
          
    
        
        
        FloorSurface --> "*" AbstractAppearance : appearance
      ...
      FloorSurface : area
        ...
        FloorSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      FloorSurface : creationDate
        
      FloorSurface : description
        
      FloorSurface : dynamizer
        
          
    
        
        
        FloorSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      FloorSurface : externalReference
        
          
    
        
        
        FloorSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      FloorSurface : featureID
        
          
    
        
        
        FloorSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      FloorSurface : fillingSurface
        
          
    
        
        
        FloorSurface --> "*" AbstractFillingSurface : fillingSurface
        click AbstractFillingSurface href "../AbstractFillingSurface/"
    

        
      FloorSurface : generalizesTo
        
          
    
        
        
        FloorSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      FloorSurface : genericAttribute
        
          
    
        
        
        FloorSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      FloorSurface : identifier
        
      FloorSurface : lod0MultiCurve
        
      FloorSurface : lod0MultiSurface
        
      FloorSurface : lod1MultiSurface
        
      FloorSurface : lod2MultiSurface
        
      FloorSurface : lod3MultiSurface
        
      FloorSurface : name
        
      FloorSurface : pointCloud
        
          
    
        
        
        FloorSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      FloorSurface : relatedTo
        
          
    
        
        
        FloorSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      FloorSurface : relativeToTerrain
        
          
    
        
        
        FloorSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      FloorSurface : relativeToWater
        
          
    
        
        
        FloorSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      FloorSurface : terminationDate
        
      FloorSurface : validFrom
        
      FloorSurface : validTo
...
| ---  | --- | --- | --- |
| [adeOfFloorSurface](adeOfFloorSurface.md) | * <br/> [ADEOfFloorSurface](ADEOfFloorSurface.md) | Augments the FloorSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:FloorSurface |
| native | citygml:FloorSurface |
...
```yaml
name: FloorSurface
description: A FloorSurface is surface that represents the interior floor of a construction.

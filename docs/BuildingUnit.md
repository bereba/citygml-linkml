...
_A BuildingUnit is a logical subdivision of a Building. BuildingUnits are formed according to some homogeneous property like function, ownership, management, or accessibility. They may be separately sold, rented out, inherited, managed, etc._
...
| ---  | --- | --- | --- |
| [adeOfBuildingUnit](adeOfBuildingUnit.md) | * <br/> [ADEOfBuildingUnit](ADEOfBuildingUnit.md) | Augments the BuildingUnit with properties defined in an ADE | direct |
| [address](address.md) | * <br/> [Address](Address.md) | Relates to the addresses that are assigned to the BuildingUnit | direct |
| [storey](storey.md) | * <br/> [Storey](Storey.md) | Relates to the storeys on which the BuildingUnit is located | direct |
...
| ---  | --- | --- | --- |
| [Storey](Storey.md) | [buildingUnit](buildingUnit.md) | range | [BuildingUnit](BuildingUnit.md) |

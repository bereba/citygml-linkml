...
_A WaterSurface represents the upper exterior interface between a water body and the atmosphere._





URI: [citygml:WaterSurface](https://www.ogc.org/standards/citygml/WaterSurface)
...
```mermaid
 classDiagram
    ...
    click WaterSurface href "../WaterSurface/"
      ...
      WaterSurface : adeOfAbstractCityObject
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      WaterSurface : adeOfAbstractFeature
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      WaterSurface : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      WaterSurface : adeOfAbstractSpaceBoundary
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractSpaceBoundary : adeOfAbstractSpaceBoundary
        click ADEOfAbstractSpaceBoundary href "../ADEOfAbstractSpaceBoundary/"
    

        
      WaterSurface : adeOfAbstractThematicSurface
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractThematicSurface : adeOfAbstractThematicSurface
        click ADEOfAbstractThematicSurface href "../ADEOfAbstractThematicSurface/"
    

        
      WaterSurface : adeOfAbstractWaterBoundarySurface
        
          
    
        
        
        WaterSurface --> "*" ADEOfAbstractWaterBoundarySurface : adeOfAbstractWaterBoundarySurface
        click ADEOfAbstractWaterBoundarySurface href "../ADEOfAbstractWaterBoundarySurface/"
    

        
      WaterSurface : adeOfWaterSurface
        
          
    
        
        
        WaterSurface --> "*" ADEOfWaterSurface : adeOfWaterSurface
        click ADEOfWaterSurface href "../ADEOfWaterSurface/"
    

        
      WaterSurface : appearance
        
          
    
        
        
        WaterSurface --> "*" AbstractAppearance : appearance
      ...
      WaterSurface : area
        ...
        WaterSurface --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      WaterSurface : creationDate
        
      WaterSurface : description
        
      WaterSurface : dynamizer
        
          
    
        
        
        WaterSurface --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      WaterSurface : externalReference
        
          
    
        
        
        WaterSurface --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      WaterSurface : featureID
        
          
    
        
        
        WaterSurface --> "1" ID : featureID
        click ID href "../ID/"
    

        
      WaterSurface : generalizesTo
        
          
    
        
        
        WaterSurface --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WaterSurface : genericAttribute
        
          
    
        
        
        WaterSurface --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      WaterSurface : identifier
        
      WaterSurface : lod0MultiCurve
        
      WaterSurface : lod0MultiSurface
        
      WaterSurface : lod1MultiSurface
        
      WaterSurface : lod2MultiSurface
        
      WaterSurface : lod3MultiSurface
        
      WaterSurface : name
        
      WaterSurface : pointCloud
        
          
    
        
        
        WaterSurface --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      WaterSurface : relatedTo
        
          
    
        
        
        WaterSurface --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      WaterSurface : relativeToTerrain
        
          
    
        
        
        WaterSurface --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      WaterSurface : relativeToWater
        
          
    
        
        
        WaterSurface --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      WaterSurface : terminationDate
        
      WaterSurface : validFrom
        
      WaterSurface : validTo
      ...
      WaterSurface : waterLevel
        ...
        WaterSurface --> "0..1" WaterLevelValue : waterLevel
        click WaterLevelValue href "../WaterLevelValue/"
...
| ---  | --- | --- | --- |
| [waterLevel](waterLevel.md) | 0..1 <br/> [WaterLevelValue](WaterLevelValue.md) | Specifies the level of the WaterSurface | direct |
| [adeOfWaterSurface](adeOfWaterSurface.md) | * <br/> [ADEOfWaterSurface](ADEOfWaterSurface.md) | Augments the WaterSurface with properties defined in an ADE | direct |
...
| ---  | ---  |
| self | citygml:WaterSurface |
| native | citygml:WaterSurface |
...
```yaml
name: WaterSurface
description: A WaterSurface represents the upper exterior interface between a water

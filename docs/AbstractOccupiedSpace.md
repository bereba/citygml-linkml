...
_AbstractOccupiedSpace is the abstract superclass for all types of physically occupied spaces. Occupied space refers to spaces that are partially or entirely filled with matter._
...
URI: [citygml:AbstractOccupiedSpace](https://www.ogc.org/standards/citygml/AbstractOccupiedSpace)
...
```mermaid
 classDiagram
    ...
    click AbstractOccupiedSpace href "../AbstractOccupiedSpace/"
      AbstractPhysicalSpace <|-- AbstractOccupiedSpace
        click AbstractPhysicalSpace href "../AbstractPhysicalSpace/"
      ...
      AbstractOccupiedSpace <|-- AbstractFillingElement
      ...
      AbstractOccupiedSpace <|-- AbstractVegetationObject
        click AbstractVegetationObject href "../AbstractVegetationObject/"
      AbstractOccupiedSpace <|-- WaterBody
        click WaterBody href "../WaterBody/"
      

      AbstractOccupiedSpace : adeOfAbstractCityObject
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      AbstractOccupiedSpace : adeOfAbstractFeature
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      AbstractOccupiedSpace : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      AbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractOccupiedSpace : adeOfAbstractOccupiedSpace
        click ADEOfAbstractOccupiedSpace href "../ADEOfAbstractOccupiedSpace/"
    

        
      AbstractOccupiedSpace : adeOfAbstractPhysicalSpace
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      AbstractOccupiedSpace : adeOfAbstractSpace
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      AbstractOccupiedSpace : appearance
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractAppearance : appearance
        click AbstractAppearance href "../AbstractAppearance/"
    

        
      AbstractOccupiedSpace : area
        
          
    
        
        
        AbstractOccupiedSpace --> "*" QualifiedArea : area
        click QualifiedArea href "../QualifiedArea/"
    

        
      AbstractOccupiedSpace : boundary
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractSpaceBoundary : boundary
        click AbstractSpaceBoundary href "../AbstractSpaceBoundary/"
    

        
      AbstractOccupiedSpace : creationDate
        
      AbstractOccupiedSpace : description
        
      AbstractOccupiedSpace : dynamizer
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      AbstractOccupiedSpace : externalReference
        
          
    
        
        
        AbstractOccupiedSpace --> "*" ExternalReference : externalReference
        click ExternalReference href "../ExternalReference/"
    

        
      AbstractOccupiedSpace : featureID
        
          
    
        
        
        AbstractOccupiedSpace --> "1" ID : featureID
        click ID href "../ID/"
    

        
      AbstractOccupiedSpace : generalizesTo
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractOccupiedSpace : genericAttribute
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractGenericAttribute : genericAttribute
        click AbstractGenericAttribute href "../AbstractGenericAttribute/"
    

        
      AbstractOccupiedSpace : identifier
        
      AbstractOccupiedSpace : lod0MultiCurve
        
      AbstractOccupiedSpace : lod0MultiSurface
        
      AbstractOccupiedSpace : lod0Point
        
      AbstractOccupiedSpace : lod1ImplicitRepresentation
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" ImplicitGeometry : lod1ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractOccupiedSpace : lod1Solid
        
      AbstractOccupiedSpace : lod1TerrainIntersectionCurve
        
      AbstractOccupiedSpace : lod2ImplicitRepresentation
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" ImplicitGeometry : lod2ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractOccupiedSpace : lod2MultiCurve
        
      AbstractOccupiedSpace : lod2MultiSurface
        
      AbstractOccupiedSpace : lod2Solid
        
      AbstractOccupiedSpace : lod2TerrainIntersectionCurve
        
      AbstractOccupiedSpace : lod3ImplicitRepresentation
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" ImplicitGeometry : lod3ImplicitRepresentation
        click ImplicitGeometry href "../ImplicitGeometry/"
    

        
      AbstractOccupiedSpace : lod3MultiCurve
        
      AbstractOccupiedSpace : lod3MultiSurface
        
      AbstractOccupiedSpace : lod3Solid
        
      AbstractOccupiedSpace : lod3TerrainIntersectionCurve
        
      AbstractOccupiedSpace : name
        
      AbstractOccupiedSpace : pointCloud
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" AbstractPointCloud : pointCloud
        click AbstractPointCloud href "../AbstractPointCloud/"
    

        
      AbstractOccupiedSpace : relatedTo
        
          
    
        
        
        AbstractOccupiedSpace --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      AbstractOccupiedSpace : relativeToTerrain
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      AbstractOccupiedSpace : relativeToWater
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" RelativeToWater : relativeToWater
        click RelativeToWater href "../RelativeToWater/"
    

        
      AbstractOccupiedSpace : spaceType
        
          
    
        
        
        AbstractOccupiedSpace --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      AbstractOccupiedSpace : terminationDate
        
      AbstractOccupiedSpace : validFrom
        
      AbstractOccupiedSpace : validTo
        
      AbstractOccupiedSpace : volume
        
          
    
        
        
        AbstractOccupiedSpace --> "*" QualifiedVolume : volume
            ...
            * [AbstractSpace](AbstractSpace.md)
                * [AbstractPhysicalSpace](AbstractPhysicalSpace.md)
                    * **AbstractOccupiedSpace**
                        ...
                        * [AbstractFillingElement](AbstractFillingElement.md)
                        * [AbstractFurniture](AbstractFurniture.md)
                        * [AbstractInstallation](AbstractInstallation.md)
                        * [CityFurniture](CityFurniture.md)
                        * [GenericOccupiedSpace](GenericOccupiedSpace.md)
...
| ---  | --- | --- | --- |
| [adeOfAbstractOccupiedSpace](adeOfAbstractOccupiedSpace.md) | * <br/> [ADEOfAbstractOccupiedSpace](ADEOfAbstractOccupiedSpace.md) | Augments AbstractOccupiedSpace with properties defined in an ADE | direct |
| [lod3ImplicitRepresentation](lod3ImplicitRepresentation.md) | 0..1 <br/> [ImplicitGeometry](ImplicitGeometry.md) | Relates to an implicit geometry that represents the occupied space in Level o... | direct |
| [lod2ImplicitRepresentation](lod2ImplicitRepresentation.md) | 0..1 <br/> [ImplicitGeometry](ImplicitGeometry.md) | Relates to an implicit geometry that represents the occupied space in Level o... | direct |
| [lod1ImplicitRepresentation](lod1ImplicitRepresentation.md) | 0..1 <br/> [ImplicitGeometry](ImplicitGeometry.md) | Relates to an implicit geometry that represents the occupied space in Level o... | direct |
...
| ---  | ---  |
| self | citygml:AbstractOccupiedSpace |
| native | citygml:AbstractOccupiedSpace |
...
<details>
```yaml
name: AbstractOccupiedSpace
description: AbstractOccupiedSpace is the abstract superclass for all types of physically
  occupied spaces. Occupied space refers to spaces that are partially or entirely
  filled with matter.
from_schema: https://www.ogc.org/standards/citygml
is_a: AbstractPhysicalSpace
abstract: true
attributes:

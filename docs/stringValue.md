...
_Specifies the "String" value of the TimeValuePair._





URI: [citygml:stringValue](https://www.ogc.org/standards/citygml/stringValue)
Alias: stringValue
...
| ---  | ---  |
| self | citygml:stringValue |
| native | citygml:stringValue |

...
# Slot: lod3TerrainIntersectionCurve 


_Relates to a 3D MultiCurve geometry that represents the terrain intersection curve of the physical space in Level of Detail 3._





URI: [citygml:lod3TerrainIntersectionCurve](https://www.ogc.org/standards/citygml/lod3TerrainIntersectionCurve)
...
| ---  | ---  |
| self | citygml:lod3TerrainIntersectionCurve |
| native | citygml:lod3TerrainIntersectionCurve |

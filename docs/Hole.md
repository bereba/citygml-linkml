...
_A Hole is an opening in the surface of a Road, Track or Square such as road damages, manholes or drains. Holes can span multiple transportation objects._
...
```mermaid
 classDiagram
    ...
    click Hole href "../Hole/"
      ...
      Hole : adeOfAbstractCityObject
        
          
    
        
        
        Hole --> "*" ADEOfAbstractCityObject : adeOfAbstractCityObject
        click ADEOfAbstractCityObject href "../ADEOfAbstractCityObject/"
    

        
      Hole : adeOfAbstractFeature
        
          
    
        
        
        Hole --> "*" ADEOfAbstractFeature : adeOfAbstractFeature
        click ADEOfAbstractFeature href "../ADEOfAbstractFeature/"
    

        
      Hole : adeOfAbstractFeatureWithLifespan
        
          
    
        
        
        Hole --> "*" ADEOfAbstractFeatureWithLifespan : adeOfAbstractFeatureWithLifespan
        click ADEOfAbstractFeatureWithLifespan href "../ADEOfAbstractFeatureWithLifespan/"
    

        
      Hole : adeOfAbstractPhysicalSpace
        
          
    
        
        
        Hole --> "*" ADEOfAbstractPhysicalSpace : adeOfAbstractPhysicalSpace
        click ADEOfAbstractPhysicalSpace href "../ADEOfAbstractPhysicalSpace/"
    

        
      Hole : adeOfAbstractSpace
        
          
    
        
        
        Hole --> "*" ADEOfAbstractSpace : adeOfAbstractSpace
        click ADEOfAbstractSpace href "../ADEOfAbstractSpace/"
    

        
      Hole : adeOfAbstractUnoccupiedSpace
        
          
    
        
        
        Hole --> "*" ADEOfAbstractUnoccupiedSpace : adeOfAbstractUnoccupiedSpace
      ...
      Hole : adeOfHole
        ...
        Hole --> "*" ADEOfHole : adeOfHole
        click ADEOfHole href "../ADEOfHole/"
      ...
      Hole : appearance
        ...
        Hole --> "*" AbstractAppearance : appearance
      ...
      Hole : boundary
        ...
        Hole --> "*" AbstractThematicSurface : boundary
      ...
      Hole : class
        ...
        Hole --> "0..1" HoleClassValue : class
        click HoleClassValue href "../HoleClassValue/"
      ...
      Hole : dynamizer
        ...
        Hole --> "*" AbstractDynamizer : dynamizer
        click AbstractDynamizer href "../AbstractDynamizer/"
    

        
      Hole : externalReference
        
          
    
        
        
        Hole --> "*" ExternalReference : externalReference
      ...
      Hole : generalizesTo
        ...
        Hole --> "*" AbstractCityObject : generalizesTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Hole : genericAttribute
        
          
    
        
        
        Hole --> "*" AbstractGenericAttribute : genericAttribute
      ...
      Hole : lod0MultiSurface
        
      Hole : lod0Point
        
      Hole : lod1Solid
        
      Hole : lod1TerrainIntersectionCurve
        
      Hole : lod2MultiCurve
        
      Hole : lod2MultiSurface
        
      Hole : lod2Solid
        
      Hole : lod2TerrainIntersectionCurve
        
      Hole : lod3MultiCurve
        
      Hole : lod3MultiSurface
        
      Hole : lod3Solid
        
      Hole : lod3TerrainIntersectionCurve
      ...
      Hole : pointCloud
        ...
        Hole --> "0..1" AbstractPointCloud : pointCloud
      ...
      Hole : relatedTo
        ...
        Hole --> "*" AbstractCityObject : relatedTo
        click AbstractCityObject href "../AbstractCityObject/"
    

        
      Hole : relativeToTerrain
        
          
    
        
        
        Hole --> "0..1" RelativeToTerrain : relativeToTerrain
        click RelativeToTerrain href "../RelativeToTerrain/"
    

        
      Hole : relativeToWater
        
          
    
        
        
        Hole --> "0..1" RelativeToWater : relativeToWater
      ...
      Hole : spaceType
        ...
        Hole --> "0..1" SpaceType : spaceType
        click SpaceType href "../SpaceType/"
    

        
      Hole : terminationDate
...
| ---  | --- | --- | --- |
| [class](class.md) | 0..1 <br/> [HoleClassValue](HoleClassValue.md) | Indicates the specific type of the Hole | direct |
| [adeOfHole](adeOfHole.md) | * <br/> [ADEOfHole](ADEOfHole.md) | Augments the Hole with properties defined in an ADE | direct |
...
| ---  | --- | --- | --- |
| [AbstractTransportationSpace](AbstractTransportationSpace.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Intersection](Intersection.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Railway](Railway.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Road](Road.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Section](Section.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Square](Square.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Track](Track.md) | [hole](hole.md) | range | [Hole](Hole.md) |
| [Waterway](Waterway.md) | [hole](hole.md) | range | [Hole](Hole.md) |
...
```yaml
name: Hole
description: A Hole is an opening in the surface of a Road, Track or Square such as
  road damages, manholes or drains. Holes can span multiple transportation objects.
...
attributes:
  class:
    name: class
    description: Indicates the specific type of the Hole.
    from_schema: https://www.ogc.org/standards/citygml
    domain_of:
    - Door
    - OtherConstruction

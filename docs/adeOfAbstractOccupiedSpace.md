...
# Slot: adeOfAbstractOccupiedSpace 


_Augments AbstractOccupiedSpace with properties defined in an ADE._
...
| Property | Value |
| --- | --- |
| Range | [ADEOfAbstractOccupiedSpace](ADEOfAbstractOccupiedSpace.md) |

...
_Specifies the degree of openness of a space._





URI: [citygml:spaceType](https://www.ogc.org/standards/citygml/spaceType)
Alias: spaceType
...
| ---  | ---  |
| self | citygml:spaceType |
| native | citygml:spaceType |

...
# Slot: dateOfConstruction 


_Indicates the date at which the construction was completed._





URI: [citygml:dateOfConstruction](https://www.ogc.org/standards/citygml/dateOfConstruction)
...
| ---  | ---  |
| self | citygml:dateOfConstruction |
| native | citygml:dateOfConstruction |

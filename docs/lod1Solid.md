...
_Relates to a 3D Solid geometry that represents the space in Level of Detail 1._





URI: [citygml:lod1Solid](https://www.ogc.org/standards/citygml/lod1Solid)
Alias: lod1Solid
...
| ---  | ---  |
| self | citygml:lod1Solid |
| native | citygml:lod1Solid |
...
```yaml
name: lod1Solid
description: Relates to a 3D Solid geometry that represents the space in Level of
  Detail 1.
